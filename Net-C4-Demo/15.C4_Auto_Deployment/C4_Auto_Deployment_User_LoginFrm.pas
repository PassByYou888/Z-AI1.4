...
begin
  ValidService.Clear;
  arry := L.SearchService(GetRegisterServiceTypFromClass(TAuto_Deployment_Client));
...
begin
  ...
  if Custom_Client_ is TAuto_Deployment_Client then
    begin
      MyClient := Custom_Client_ as TAuto_Deployment_Client;
