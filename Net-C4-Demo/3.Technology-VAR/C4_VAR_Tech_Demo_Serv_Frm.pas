...
uses
  ...
  PasAI.Core, PasAI.PascalStrings, PasAI.Status, PasAI.UnicodeMixedLib, PasAI.ListEngine,
  PasAI.Geometry2D, PasAI.DFE, PasAI.Json, PasAI.Number,
  PasAI.Notify, PasAI.Cipher, PasAI.MemoryStream,
  PasAI.Net, PasAI.Net.PhysicsIO, PasAI.Net.C4, PasAI.Net.C4_Var;
...
begin
  ...
  PasAI.Net.C4.C40_Password := '123456';
  // 挂接StatusIO以便状态打印
...
var
  ...
  i: Integer;
begin
  with TC40_PhysicsService.Create(AddrEdit.Text, umlStrToInt(PortEdit.Text), PasAI.Net.PhysicsIO.TPhysicsServer.Create) do
    begin
