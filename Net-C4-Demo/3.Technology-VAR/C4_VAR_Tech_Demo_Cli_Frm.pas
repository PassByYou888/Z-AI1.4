...
uses
  ...
  PasAI.Number,
  PasAI.Net, PasAI.Net.PhysicsIO, PasAI.Net.C4, PasAI.Net.C4_Var, PasAI.Net.C4_FS, PasAI.Net.C4_UserDB;
...
begin
  PasAI.Net.C4.C40_PhysicsTunnelPool.GetOrCreatePhysicsTunnel(AddrEdit.Text, umlStrToInt(PortEdit.Text), dependEdit.Text, self);
end;
