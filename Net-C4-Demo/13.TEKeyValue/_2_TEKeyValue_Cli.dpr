...
begin
  // 关闭log
  PasAI.Net.C4.C40SetQuietMode(True);
...
begin
  ...
  PasAI.Net.C4_Console_APP.C40AppParam := ['Tunnel("127.0.0.1",9188,"TEKeyValue")'];

  PasAI.Net.C4.C40_ClientPool.WaitConnectedDoneC('TEKeyValue', Do_Connection_Done);
