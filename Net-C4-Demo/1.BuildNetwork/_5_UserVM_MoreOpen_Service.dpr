...
begin
  ...
  PasAI.Net.C4.C40_PhysicsTunnelPool.GetOrCreatePhysicsTunnel(Internet_DP_Addr_, Internet_DP_Port_, 'dp|FS|UserDB|var', TMonitorMySAAS.Create);

  // 循环检查指定端是否准备就绪,便于我们触发某些事件
  PasAI.Net.C4.C40_ClientPool.WaitConnectedDoneP('dp|fs|UserDB|var', procedure(States_: TC40_Custom_ClientPool_Wait_States)
    begin
