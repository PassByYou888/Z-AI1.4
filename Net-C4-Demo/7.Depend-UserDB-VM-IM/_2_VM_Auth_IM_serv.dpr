...
uses
  ...
  PasAI.Status,
  PasAI.Notify,
  PasAI.Net.PhysicsIO, PasAI.Json,
...
begin
  // 先从SAAS网络找服务器
  arry := PasAI.Net.C4.C40_ServicePool.GetFromServiceTyp('MyVA');
...
begin
  ...
  PasAI.Net.C4.C40_PhysicsTunnelPool.GetOrCreatePhysicsTunnel(Internet_DP_Addr_, Internet_DP_Port_, 'DP|UserDB', TMyClientIntf.Create);
