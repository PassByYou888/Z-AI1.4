...
uses
  ...
  PasAI.Parsing, PasAI.UnicodeMixedLib, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.Core,
  PasAI.DrawEngine, PasAI.DrawEngine.FMX, PasAI.MemoryRaster, PasAI.Geometry2D,
  PasAI.Cadencer, FMX.Colors, FMX.Memo.Types;
...
type
  ...
  public
    ...
    procedure BuildSequenceFrameList(bmp: TSequenceMemoryPasAI_Raster; bIdx, eIdx: Integer); overload;
...
var
  ...
  Li: TListBoxItem;
  img: TImage;
  bmp: TSequenceMemoryPasAI_Raster;
begin
  ListBox.Clear;
  ListBox.BeginUpdate;
  ...
  for i := 0 to Memo.Lines.Count - 1 do
    begin
      ...
      bmp := TSequenceMemoryPasAI_Raster.Create;
...
procedure TSequenceGenerateForm.BuildSequenceFrameList(bmp: TSequenceMemoryPasAI_Raster; bIdx, eIdx: Integer);
var
  i: Integer;
...
var
  ...
  img: TImage;
  i: Integer;
  output: TSequenceMemoryPasAI_Raster;
begin
