...
uses
  ...
  PasAI.Core, PasAI.DrawEngine, PasAI.DrawEngine.SlowFMX, PasAI.MemoryRaster, PasAI.Geometry2D,
  PasAI.DrawEngine.PictureViewer, FMX.Objects;
...
procedure ShowImage(img: TMPasAI_Raster); overload;
procedure ShowImage2(img: TMPasAI_Raster; title: string); overload;
...
procedure ShowImage(img: TMPasAI_Raster);
begin
  ShowImageForm.Viewer.InputPicture(img, '', False, False);
  ShowImageForm.Show;
end;

procedure ShowImage2(img: TMPasAI_Raster; title: string);
begin
