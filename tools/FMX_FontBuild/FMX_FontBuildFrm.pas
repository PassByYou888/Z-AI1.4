...
uses
  ...
  PasAI.MemoryStream, PasAI.MemoryRaster, PasAI.Geometry2D, PasAI.Status, PasAI.PascalStrings,
  PasAI.UnicodeMixedLib, PasAI.DrawEngine, PasAI.DrawEngine.SlowFMX, PasAI.ZAI.Common;
