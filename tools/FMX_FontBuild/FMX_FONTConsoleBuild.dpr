...
uses
  ...
  PasAI.MemoryStream, PasAI.MemoryRaster, PasAI.Geometry2D, PasAI.Status, PasAI.PascalStrings, PasAI.UPascalStrings,
  PasAI.FastGBK,
  PasAI.UnicodeMixedLib, PasAI.DrawEngine, PasAI.DrawEngine.SlowFMX, PasAI.DrawEngine.FMXCharacterMapBuilder;
...
var
  ...
  i, j: Integer;
begin
  SetLength(Result, TFontPasAI_Raster.C_MAXWORD + 1);
  j := 0;
  for i := 0 to TFontPasAI_Raster.C_MAXWORD do
    begin
      c := USystemChar(i);
