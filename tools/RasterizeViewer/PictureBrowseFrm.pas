...
uses
  ...
  PasAI.PascalStrings,
  PasAI.ZDB.HashField_LIB, PasAI.ZDB, PasAI.UnicodeMixedLib, PasAI.ZDB.ObjectData_LIB,
  PasAI.Core, PasAI.MemoryStream, PasAI.ZDB.ItemStream_LIB, PasAI.Status,
  PasAI.MemoryRaster, PasAI.DrawEngine.SlowFMX, PasAI.DrawEngine;
...
begin
  ...
  ShowImage2(NewPasAI_RasterFromFile(li.FileName), li.FileName);
end;
