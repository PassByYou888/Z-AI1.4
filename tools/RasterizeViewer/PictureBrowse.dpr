...
uses
  ...
  PasAI.MemoryRaster,
  FMX.Types,
  PictureBrowseFrm in 'PictureBrowseFrm.pas' {PictureBrowseForm},
  StyleModuleUnit in '..\common\StyleModuleUnit.pas' {StyleDataModule: TDataModule},
  ShowImageFrm in '..\common\ShowImageFrm.pas' {ShowImageForm};
...
begin
  ...
  Application.CreateForm(TPictureBrowseForm, PictureBrowseForm);
  Application.CreateForm(TShowImageForm, ShowImageForm);
  Application.Run;
  FreeGlobalMedia();
end.
