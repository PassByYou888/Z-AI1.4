...
uses
  ...
  ObjectDataManagerFrameUnit, PasAI.MemoryStream, PasAI.ZDB.HashField_LIB, PasAI.ZDB,
  PasAI.UnicodeMixedLib, PasAI.Core, PasAI.Status, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.ZDB.FileIndexPackage_LIB;
