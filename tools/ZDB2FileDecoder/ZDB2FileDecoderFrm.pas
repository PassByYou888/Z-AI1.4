...
{$ENDIF FPC}
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.Status, PasAI.MemoryStream,
  PasAI.ZDB2.FileEncoder, PasAI.ZDB2, PasAI.Expression, Vcl.Mask;
