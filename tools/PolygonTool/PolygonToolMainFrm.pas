...
uses
  ...
  PasAI.DrawEngine.SlowFMX, PasAI.DrawEngine, PasAI.Geometry2D, PasAI.Geometry3D, PasAI.Notify,
  PasAI.MemoryRaster,
  PasAI.MemoryStream,
  PasAI.Learn, PasAI.Learn.Type_LIB,
  PasAI.FFMPEG.Reader, FMX.Memo.Types;
...
type
  ...
  public
    ...
    // other
    backgroundTexture: TMPasAI_Raster;
...
procedure OpenFreeGeometryEditor(raster: TMPasAI_Raster);
procedure OpenFreeGeometry_Return_Mode_Editor(raster: TMPasAI_Raster; info_: U_String; polygon_stream, renderer_options_stream: TMS64; On_Result: TOn_PolygonTool_Result);
...
begin
  ...
  backgroundTexture := NewPasAI_RasterFromFile(OpenPictureDialog.FileName);
end;
