...
uses
  ...
  PasAI.MemoryRaster,
  FMX.Types,
  PolygonToolMainFrm in 'PolygonToolMainFrm.pas' {PolygonToolMainForm},
...
begin
  ...
  Application.CreateForm(TPolygonToolMainForm, PolygonToolMainForm);
