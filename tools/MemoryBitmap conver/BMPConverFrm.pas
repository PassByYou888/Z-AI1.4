...
uses
  ...
  PasAI.Core, PasAI.Status, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib,
  PasAI.MemoryRaster, PasAI.DrawEngine,
  PasAI.Geometry2D,
  PasAI.DrawEngine.SlowFMX, PasAI.DrawEngine.PictureViewer;
...
var
  r: TMPasAI_Raster;
begin
  r := NewPasAI_RasterFromFile(TListBoxItem(Sender).TagString);
  r.BlendBlack;
  Viewer.Clear;
...
begin
  ...
  for i := 0 to ListBox.Count - 1 do
    begin
      ...
      b := TSequenceMemoryPasAI_Raster.Create;
      LoadMemoryBitmap(itm.TagString, b);
      b.BlendBlack;
