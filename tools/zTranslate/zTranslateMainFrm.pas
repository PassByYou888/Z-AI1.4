...
uses
  ...
  PasAI.TextTable, PasAI.TextDataEngine, PasAI.Core, PasAI.UnicodeMixedLib, PasAI.Parsing,
  PasAI.MemoryStream, PasAI.Status, PasAI.PascalStrings, PasAI.UPascalStrings, BaiduTranslateClient,
  PasAI.Net, Vcl.Mask;
...
begin
  ...
  for J := 0 to tp.ParsingData.Cache.TextDecls.Count - 1 do
    begin
      pPos := tp.ParsingData.Cache.TextDecls[J];
      if umlTrimSpace(TTextParsing.Translate_Pascal_Decl_To_Text(pPos^.Text)).Len > 0 then
        begin
