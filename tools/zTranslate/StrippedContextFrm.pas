...
uses
  ...
  PasAI.TextTable, PasAI.DFE, PasAI.Core, PasAI.ListEngine, PasAI.Status, PasAI.MemoryStream,
  PasAI.Geometry2D, PasAI.UnicodeMixedLib, QuickTranslateFrm, PasAI.Parsing, PasAI.PascalStrings, PasAI.UPascalStrings, VCLLogFrm;
...
type
  ...
  public
    ...
    procedure LoadNewCTFromStream(m64: TMS64);
    procedure NewCT;
...
begin
  case p^.TextStyle of
    tsPascalText: Result := TTextParsing.Translate_Pascal_Decl_To_Text(p^.OriginText);
    tsPascalComment: Result := TTextParsing.Translate_Pascal_Decl_Comment_To_Text(p^.OriginText);
    tsCText: Result := TTextParsing.Translate_C_Decl_To_Text(p^.OriginText);
    tsCComment: Result := TTextParsing.Translate_C_Decl_Comment_To_Text(p^.OriginText);
    tsDFMText: Result := TTextParsing.Translate_Pascal_Decl_To_Text(p^.OriginText);
...
begin
  case p^.TextStyle of
    tsPascalText: Result := TTextParsing.Translate_Pascal_Decl_To_Text(p^.DefineText);
    tsPascalComment: Result := TTextParsing.Translate_Pascal_Decl_Comment_To_Text(p^.DefineText);
    tsCText: Result := TTextParsing.Translate_C_Decl_To_Text(p^.DefineText);
    tsCComment: Result := TTextParsing.Translate_C_Decl_Comment_To_Text(p^.DefineText);
    tsDFMText: Result := TTextParsing.Translate_Pascal_Decl_To_Text(p^.DefineText);
...
begin
  ...
  case FOpenPtr^.TextStyle of
    tsPascalText: FOpenPtr^.DefineText := TTextParsing.Translate_Text_To_Pascal_Decl(n);
    tsPascalComment: FOpenPtr^.DefineText := TTextParsing.Translate_Text_To_Pascal_Decl_Comment(n);
    tsCText: FOpenPtr^.DefineText := TTextParsing.Translate_Text_To_C_Decl(n);
    tsCComment: FOpenPtr^.DefineText := TTextParsing.Translate_Text_To_C_Decl_Comment(n);
    tsDFMText: FOpenPtr^.DefineText := TTextParsing.Translate_Text_To_Pascal_Decl_With_Unicode(n);
...
procedure TStrippedContextForm.LoadNewCTFromStream(m64: TMS64);
begin
  FTextData.LoadFromStream(m64);
  RefreshTextList(True);
end;
