...
uses
  ...
  PasAI.TextDataEngine, PasAI.Core, PasAI.ListEngine, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.Status,
  PasAI.UnicodeMixedLib, PasAI.MemoryRaster, PasAI.MemoryStream, Vcl.Mask;
...
var
  ...
  X, Y: Integer;
  SeqRaster: TSequenceMemoryPasAI_Raster;
...
begin
  ...
  for i := 0 to inputFiles.Count - 1 do
    begin
      ...
      if (umlMultipleMatch(['*.seq'], sour)) and (TSequenceMemoryPasAI_Raster.CanLoadFile(sour)) then
        begin
          SeqRaster := TSequenceMemoryPasAI_Raster.Create;
      ...
      else if TMPasAI_Raster.CanLoadFile(sour) then
        begin
          raster := TMPasAI_Raster.Create;
