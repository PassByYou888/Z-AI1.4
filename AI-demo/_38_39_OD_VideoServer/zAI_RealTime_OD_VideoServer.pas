...
type
  ...
  TOD_VideoIO_ = class(TPeer_IO_User_Special)
  public
  ...
  TRealTime_OD_VideoServer = class(TZNet_DoubleTunnelService_NoAuth)
  private
    OD_Parallel: TPas_AI_Parallel;
...
procedure TRealTime_OD_VideoServer.cmd_OD(Sender: TPeerIO; InData: TDFE);
var
  p: PCardinal;
begin
...
constructor TRealTime_OD_VideoServer.Create(ARecvTunnel, ASendTunnel: TZNet_Server);
var
  fn: U_String;
  m64: TMS64;
begin
  ...
  OD_Parallel := TPas_AI_Parallel.Create;
...
procedure TRealTime_OD_VideoServer.SendVideo(send_id: Cardinal; frame: TMS64);
begin
...
procedure TRealTime_OD_VideoServer.LoadSystem(m64: TMS64);
begin
