...
type
  ...
  TInternetClient = class(TZNet_DoubleTunnelClient_NoAuth)
  public
    ...
    procedure MyEndSave();
    procedure MyQuery(dbName: U_String; Reverse: Boolean; MaxResult: Int64; VL: THashVariantList; OnResult: TOnStream_M);
    procedure MyDownload(dbName: U_String; StorePos: Int64; OnResult: TOnStream_M);
...
var
  ...
  InternetRecvTunnel, InternetSendTunnel: TZNet_WithP2PVM_Client;
...
procedure TInternetClient.MyQuery(dbName: U_String; Reverse: Boolean; MaxResult: Int64; VL: THashVariantList; OnResult: TOnStream_M);
var
  d: TDFE;
begin
  d := TDFE.Create;
...
procedure TInternetClient.MyDownload(dbName: U_String; StorePos: Int64; OnResult: TOnStream_M);
var
  d: TDFE;
begin
  d := TDFE.Create;
...
procedure InitInternetCli;
begin
  InternetRecvTunnel := TZNet_WithP2PVM_Client.Create;
  InternetRecvTunnel.QuietMode := IsQuiet;

  InternetSendTunnel := TZNet_WithP2PVM_Client.Create;
...
procedure ConnectToInternetPhysicsService_DoneEvent(Sender: TZNet; P_IO: TPeerIO);
begin
