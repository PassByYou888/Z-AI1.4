...
uses
  ...
  PasAI.MemoryRaster, PasAI.DrawEngine, PasAI.Geometry2D, PasAI.DrawEngine.SlowFMX,
  PasAI.h264.Y4M, PasAI.h264, PasAI.PascalStrings, PasAI.Core, PasAI.UnicodeMixedLib;
  ...
  begin
    ...
    for i := yR.CurrentFrame to yR.FrameCount - 1 do
      begin
        ...
        raster.DrawText('hello world', 0, 0, Vec2(1, 0), -15, 0.9, 28, PasAI_RasterColorF(1, 0, 0, 0.5));
  ...
  begin
    ...
    for i := yR.CurrentFrame to yR.FrameCount - 1 do
      begin
        ...
        raster.DrawText('hello world', 0, 0, Vec2(1, 0), -15, 0.9, 28, PasAI_RasterColorF(1, 0, 0, 0.5));
        enWriter.WriteFrame(raster);
        Memo.Text := Format('encoder information: Z.h264' + #13#10 +
          'output %s = %s' + #13#10 +
          'size %d * %d' + #13#10 +
          'frame %d / %d',
