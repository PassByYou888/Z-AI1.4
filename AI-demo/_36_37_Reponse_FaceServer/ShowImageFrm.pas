...
uses
  ...
  PasAI.DrawEngine.SlowFMX, PasAI.MemoryRaster, FMX.Objects;
...
procedure ShowImage(img: TMPasAI_Raster; title: string); overload;
...
procedure ShowImage(img: TMPasAI_Raster; title: string);
var
  ShowImageForm: TShowImageForm;
begin
  ShowImageForm := TShowImageForm.Create(Application);
