...
uses
  ...
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.Cipher, PasAI.Status, PasAI.Notify, PasAI.MemoryStream,
  PasAI.ListEngine,
...
begin
  ...
  Sim_Mem_DB := TZDB2_Th_Engine_Marshal.Create(nil);
