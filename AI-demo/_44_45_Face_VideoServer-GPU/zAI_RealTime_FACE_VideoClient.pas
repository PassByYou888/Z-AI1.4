...
{$ENDIF FPC}
  ...
  TOn_FACE_Result = procedure(Sender: TRealTime_FACE_VideoClient; video_stream: TMS64; video_info: TFACE_Video_Info) of object;

  TRealTime_FACE_VideoClient = class(TZNet_DoubleTunnelClient_NoAuth)
  private
  ...
  public
    ...
    procedure Input_FACE(r: TMPasAI_Raster);
  end;
...
procedure TRealTime_FACE_VideoClient.cmd_VideoInfo(Sender: TPeerIO; InData: TDFE);
var
...
constructor TRealTime_FACE_VideoClient.Create(ARecvTunnel, ASendTunnel: TZNet_Client);
begin
...
procedure TRealTime_FACE_VideoClient.Input_FACE(r: TMPasAI_Raster);
var
  m64: TMS64;
begin
  m64 := TMS64.Create;
