...
type
  ...
  private
    ...
    procedure OD_Result(Sender: TRealTime_FACE_VideoClient; video_stream: TMS64; video_info: TFACE_Video_Info);
  public
...
procedure Trealtime_Face_Video_FMXClientForm.OD_Result(Sender: TRealTime_FACE_VideoClient; video_stream: TMS64; video_info: TFACE_Video_Info);
begin
