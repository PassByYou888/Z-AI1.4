...
uses
  ...
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.ListEngine, PasAI.Status, PasAI.Parsing, PasAI.Expression, PasAI.OpCode,
  FMX.Memo.Types;
...
begin
  ...
  psList := SystemOpRunTime.GetAllProcDescription;
