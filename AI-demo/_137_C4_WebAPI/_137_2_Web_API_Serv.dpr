...
uses
  ...
  // web服务器使用ics
  PasAI.OverbyteIcsDigestAuth, PasAI.OverbyteIcsWSocket, PasAI.OverbyteIcsHttpSrv, PasAI.OverbyteIcsMimeUtils, PasAI.OverbyteIcsFormDataDecoder,
  // z系各种库
  ...
  PasAI.MemoryStream, PasAI.ListEngine, PasAI.Json, PasAI.Notify, PasAI.DFE, PasAI.Net, PasAI.Net.PhysicsIO, PasAI.Net.C4, PasAI.Net.C4_Console_APP,
...
begin
  ...
  DisposeObject(L);
  PasAI.Net.C4_Console_APP.C40_Extract_CmdLine(tsC, [umlBatchReplace('KeepAlive("<host>",<port>,"demo", True)', arry, False, True, 0, 0)]);
end;
