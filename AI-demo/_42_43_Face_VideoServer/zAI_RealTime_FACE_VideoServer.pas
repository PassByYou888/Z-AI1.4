...
type
  ...
  private
    // work on cpu
    face_det_para: TPas_AI_Parallel;
    // work on gpu
    Face_Metric: TPas_AI;
...
begin
  ...
  face_hnd := ai.Face_Detector_All(mr, PasAI.ZAI.C_Metric_Input_Size);
...
begin
  ...
  // cpu worker
  face_det_para := TPas_AI_Parallel.Create;
  face_det_para.Prepare_Parallel;
  face_det_para.Prepare_FaceSP;
  // gpu worker
