...
uses
  ...
  PasAI.DrawEngine, PasAI.DrawEngine.SlowFMX, PasAI.Core, PasAI.MemoryRaster, PasAI.Geometry2D;
...
begin
  d := TDrawEngine.Create;
  d.PasAI_Raster_.UsedAgg := usedAggCheckBox.IsChecked;
  d.PasAI_Raster_.SetSize(RectV2(0, 0, Image.width, Image.height));
  TPasAI_RasterVertex.DebugTriangle := TriCheckBox.IsChecked;
  Render(d);
  MemoryBitmapToBitmap(d.PasAI_Raster_.Memory, Image.Bitmap);
  DisposeObject(d);
end;
