...
{$ENDIF FPC}
  ...
  TOn_MMOD_Result = procedure(Sender: TRealTime_MMOD_VideoClient; video_stream: TMS64; video_info: TMMOD_Video_Info) of object;

  TRealTime_MMOD_VideoClient = class(TZNet_DoubleTunnelClient_NoAuth)
  private
  ...
  public
    ...
    procedure Input_MMOD(r: TMPasAI_Raster);
  end;
...
procedure TRealTime_MMOD_VideoClient.cmd_VideoInfo(Sender: TPeerIO; InData: TDFE);
var
...
constructor TRealTime_MMOD_VideoClient.Create(ARecvTunnel, ASendTunnel: TZNet_Client);
begin
...
procedure TRealTime_MMOD_VideoClient.Input_MMOD(r: TMPasAI_Raster);
var
  m64: TMS64;
begin
  m64 := TMS64.Create;
