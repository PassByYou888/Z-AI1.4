...
uses
  ...
  PasAI.Core, PasAI.PascalStrings, PasAI.DFE, PasAI.Geometry2D,
  PasAI.Json,
  PasAI.Status,
...
type
  ...
  private
    ...
    destAngle: TGeoFloat;
    // 粒子系统绑定的序列帧
    sequenceAnimateTexture: TPasAI_Raster;
    // 粒子系统
...
begin
  ...
  sequenceAnimateTexture := NewPasAI_RasterFromStream(stream);
  stream.Free;
  ...
  // 粒子大小
  particles.ParticleSize := 20;
  particles.ParticleSizeMinScale := 1.0;
  ...
  // 每秒生成粒子
  particles.GenSpeedOfPerSecond := 1000;
  // 开启粒子自动生成
...
begin
  ...
  // 画中心目标
  //d.DrawEllipse(cenBox, DEColor(1, 0.5, 0.5), 2);
  // 画旋转目标
  //d.DrawEllipse(destBox, DEColor(1, 0.5, 0.5), 2);
  // 画粒子
