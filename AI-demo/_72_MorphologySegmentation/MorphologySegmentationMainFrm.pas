...
uses
  ...
  PasAI.Core, PasAI.UnicodeMixedLib, PasAI.PascalStrings, PasAI.Geometry2D, PasAI.MemoryRaster, PasAI.MemoryStream,
  PasAI.Status,
  PasAI.DrawEngine, PasAI.DrawEngine.SlowFMX;
...
type
  ...
  public
    ...
    tex_box: TRectV2;
    pickColor: TRColor;
    SegImgList: TMemoryPasAI_RasterList;
...
begin
  ...
  tex := NewPasAI_RasterFromFile(umlCombineFileName(TPath.GetLibraryPath, 'ColorSeg1.bmp'));
  SegImgList := TMemoryPasAI_RasterList.Create;
    ...
    begin
      ...
      DelphiParallelFor(0, s.count - 1, procedure(pass: Integer)
        ...
        begin
          ...
          nm := sp.BuildClipDatamap(RColor(0, 0, 0, 0), PasAI_RasterAlphaColor(pickColor, $7F));
...
begin
  ...
  DisposeObject(tex);
  tex := NewPasAI_RasterFromFile(OpenDialog1.FileName);
  SetLength(LastSegBox, 0);
end;
