...
uses
  ...
  PasAI.Core, PasAI.UnicodeMixedLib, PasAI.PascalStrings, PasAI.Geometry2D, PasAI.Geometry3D,
  PasAI.MemoryRaster, PasAI.ListEngine, PasAI.DrawEngine, PasAI.DrawEngine.SlowFMX;
...
function GetTextFont(text: string; siz: TGeoFloat; Color, EdgeColor: TDEColor; borderSiz: Integer): TMPasAI_Raster;
...
begin
  ...
  if Result = nil then
    begin
      ...
      tmpDrawEng.PasAI_Raster_.SetWorkMemory(Result);
      tmpDrawEng.SetSize;
      ...
      tmpRaster := TMPasAI_Raster.Create;
