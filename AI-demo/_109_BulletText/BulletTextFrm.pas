...
uses
  ...
  PasAI.DrawEngine, PasAI.BulletMovementEngine, PasAI.MemoryRaster, PasAI.MediaCenter, PasAI.ZDB.HashItem_LIB,
...
begin
  ...
  if (fontComboBox.ItemIndex >= 0) and (fontComboBox.Items.Objects[fontComboBox.ItemIndex] <> nil) then
    begin
      fr := fontComboBox.Items.Objects[fontComboBox.ItemIndex] as TFontPasAI_Raster;
...
begin
  ...
  TCompute.RunP_NP(procedure
    ...
    begin
      ...
      fl := TFontPasAI_RasterList.Create;
      L := TCore_List.Create;
