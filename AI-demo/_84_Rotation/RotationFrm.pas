...
uses
  ...
  PasAI.Expression,
  PasAI.DrawEngine.FMX, PasAI.ZAI.Common, FMX.Memo.Types;
...
type
  ...
  public
    ...
    function RebuildRect(raster: TMPasAI_Raster; Angle_, scale_: TGeoFloat; rotate_axis_, offset_: TVec2): TV2R4;
...
begin
  ...
  sour := NewPasAI_RasterFromFile(WhereFileFromConfigure('lena.bmp'));
...
function TApproximatePolygonForm.RebuildRect(raster: TMPasAI_Raster; Angle_, scale_: TGeoFloat; rotate_axis_, offset_: TVec2): TV2R4;
begin
