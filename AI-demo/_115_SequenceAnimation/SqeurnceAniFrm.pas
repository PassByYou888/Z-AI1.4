...
uses
  ...
  PasAI.Core, PasAI.Geometry2D, PasAI.UnicodeMixedLib,
  PasAI.MemoryRaster, PasAI.DrawEngine, PasAI.MediaCenter,
  PasAI.DrawEngine.SlowFMX, FMX.Memo.Types, FMX.ScrollBox, FMX.Memo;
