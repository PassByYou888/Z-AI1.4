program _32_KDTree_Analysis_EasyConsoleDemo;
...
var
  ...
  n: string;
  NearestNodes: TKDT1DD.TNearest_Nodes_List;
begin
  { TKDT1DD是指k维空间是1维的Double类型 }
  k1t := TKDT1DD.Create;

  NearestNodes := TKDT1DD.TNearest_Nodes_List.Create;
      ...
      begin
        if umlMultipleMatch(['buff'], n) then
          ...
          begin
            ...
            DoStatus(Format('finished total:%d Nearest:%d distance:%f', [SearchedCounter, k1r^.Vec^.index,
