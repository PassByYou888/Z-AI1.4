program _71_PascalCodeDependencyAnslysis;
...
uses SysUtils,
{$IFDEF FPC}
  PasAI.FPC.GenericList, // 让fpc编译器支持泛型，需要这个库
{$ENDIF FPC}
  PasAI.Core, PasAI.PascalStrings, PasAI.Parsing, PasAI.UnicodeMixedLib, PasAI.Status, PasAI.ListEngine;
...
{$ENDIF FPC}
  ...
  TPascalUnit = class(TCore_Object)
  public
  ...
  public
    ...
    procedure AddPascalCode(code: TCore_Strings); overload;
...
procedure TPascalUnitList.AddPascalCode(code: TCore_Strings);
begin
