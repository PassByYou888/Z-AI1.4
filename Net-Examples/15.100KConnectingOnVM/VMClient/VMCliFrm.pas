...
uses
  ...
  PasAI.Net.Client.ICS,
  PasAI.Net.Client.Indy,
  PasAI.Net.Client.CrossSocket,
  PasAI.PascalStrings, PasAI.Status, PasAI.Core, PasAI.DFE, PasAI.UnicodeMixedLib, PasAI.MemoryStream,
  PasAI.Notify, PasAI.Net.Test, PasAI.ListEngine;
