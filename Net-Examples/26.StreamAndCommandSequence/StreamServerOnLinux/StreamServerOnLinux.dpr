...
type
  ...
  public
    ...
    procedure cmd_MyBigStream(Sender: TPeerIO; InData: TCore_Stream; BigStreamTotal, BigStreamCompleteSize: Int64);
...
procedure TSingleTunnelServer.cmd_MyBigStream(Sender: TPeerIO; InData: TCore_Stream; BigStreamTotal, BigStreamCompleteSize: Int64);
begin
