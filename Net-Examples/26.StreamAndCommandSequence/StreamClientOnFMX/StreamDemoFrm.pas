...
uses
  ...
  PasAI.Core, PasAI.PascalStrings, PasAI.UnicodeMixedLib, PasAI.MemoryStream, PasAI.DFE, PasAI.Notify,
  PasAI.Net, PasAI.Net.XNAT.Physics, PasAI.Status, PasAI.Cipher, PasAI.Net.DoubleTunnelIO.NoAuth;
...
type
  ...
  public
    ...
    DoubleTunnelClient: TZNet_DoubleTunnelClient_NoAuth;
...
begin
  ...
  DoubleTunnelClient := TZNet_DoubleTunnelClient_NoAuth.Create(TXPhysicsClient.Create, TXPhysicsClient.Create);
