...
uses
  ...
  PasAI.Core, PasAI.PascalStrings, PasAI.UnicodeMixedLib, PasAI.Net,
  PasAI.Net.XNAT.MappingOnVirutalService, PasAI.Net.XNAT.Physics, PasAI.Net.Test, PasAI.Status, PasAI.Notify,
  FMX.Memo.Types;
