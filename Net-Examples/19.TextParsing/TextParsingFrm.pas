...
uses
  ...
  PasAI.PascalStrings, PasAI.Parsing, PasAI.Core, PasAI.UnicodeMixedLib, PasAI.Expression, PasAI.OpCode, PasAI.MemoryStream, PasAI.ListEngine,
  PasAI.Status,
  TypInfo,
...
var
  ...
  pt: PTokenData;
begin
  PasAI.Parsing.SpacerSymbol.V:=umlDeleteChar(PasAI.Parsing.SpacerSymbol.V, '.');
