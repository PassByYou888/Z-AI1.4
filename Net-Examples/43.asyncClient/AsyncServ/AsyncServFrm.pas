...
uses
  ...
  PasAI.DFE, PasAI.UnicodeMixedLib, PasAI.MemoryStream;
...
procedure TAsyncServerForm.cmd_Test128MBigStream(Sender: TPeerClient; InData: TCore_Stream; BigStreamTotal, BigStreamCompleteSize: Int64);
var
  tempStream: TMemoryStream64;
begin
