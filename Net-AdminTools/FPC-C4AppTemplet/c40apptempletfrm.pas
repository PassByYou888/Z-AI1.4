...
uses
  ...
  PasAI.ListEngine, PasAI.HashList.Templet, PasAI.Expression, PasAI.OpCode, PasAI.Parsing,
  PasAI.DFE, PasAI.TextDataEngine,
  ...
  PasAI.ZDB.FileIndexPackage_LIB, PasAI.ZDB.FilePackage_LIB, PasAI.ZDB.ItemStream_LIB,
  PasAI.ZDB.HashField_LIB, PasAI.ZDB.HashItem_LIB,
  PasAI.ZDB2, PasAI.ZDB2.DFE, PasAI.ZDB2.HS, PasAI.ZDB2.HV, PasAI.ZDB2.Json,
  PasAI.ZDB2.MS64, PasAI.ZDB2.NM, PasAI.ZDB2.TE, PasAI.ZDB2.FileEncoder,
  PasAI.Net.C4, PasAI.Net.C4_UserDB, PasAI.Net.C4_Var, PasAI.Net.C4_FS, PasAI.Net.C4_RandSeed,
  PasAI.Net.C4_Log_DB,
...
type
  TC40AppTempletForm = class(TForm)
    ...
    JoinAuto_CheckBox: TCheckBox;
    JoinMinWorkload_CheckBox: TCheckBox;
...
begin
  with PasAI.Net.C4.TC40_PhysicsService.Create(ServListeningIPEdit.Text,
      ServIPEdit.Text, EStrToInt(ServPortEdit.Text, 0),
      PasAI.Net.PhysicsIO.TPhysicsServer.Create) do
  begin
...
begin
  ...
  if SelectDirectory('Select C40 Root Directory.', '', dir_) then
...
begin
  ...
  PasAI.Net.C4.C40WriteConfig(HS);
  ...
  param.Add(Format('Password(%s)', [conv_(PasAI.Net.C4.C40_Password)]));
...
begin
  ...
  TE.LoadFromFile(fn);
  PasAI.Net.C4.C40ReadConfig(TE.HStringList['Sys']);
  ReloadOpt;
...
begin
  ...
  TE := THashTextEngine.Create;
  ApplyOpt;
  PasAI.Net.C4.C40WriteConfig(TE.HStringList['Sys']);
...
begin
  ...
  for i := 0 to PasAI.Net.C4.C40_Registed.Count - 1 do
  begin
    p := PasAI.Net.C4.C40_Registed[i];
...
begin
  QuietCheckBox.Checked := PasAI.Net.C4.C40_QuietMode;
  SafeCheckTimerEdit.Text := umlIntToStr(PasAI.Net.C4.C40_SafeCheckTime);
  PhysicsReconnectionDelayEdit.Text :=
    umlShortFloatToStr(PasAI.Net.C4.C40_PhysicsReconnectionDelayTime);
  UpdateServiceInfoTimerEdit.Text :=
    umlIntToStr(PasAI.Net.C4.C40_UpdateServiceInfoDelayTime);
  PhysicsServiceTimeoutEdit.Text := umlIntToStr(PasAI.Net.C4.C40_PhysicsServiceTimeout);
  PhysicsTunnelTimeoutEdit.Text := umlIntToStr(PasAI.Net.C4.C40_PhysicsTunnelTimeout);
  KillIDCFaultTimeoutEdit.Text := umlIntToStr(PasAI.Net.C4.C40_KillIDCFaultTimeout);
  RootDirectoryEdit.Text := PasAI.Net.C4.C40_RootPath;
  passwdEdit.Text := PasAI.Net.C4.C40_Password;
end;

procedure TC40AppTempletForm.ApplyOpt;
begin
  PasAI.Net.C4.C40SetQuietMode(QuietCheckBox.Checked);
  PasAI.Net.C4.C40_SafeCheckTime :=
    EStrToInt(SafeCheckTimerEdit.Text, PasAI.Net.C4.C40_SafeCheckTime);
  PasAI.Net.C4.C40_PhysicsReconnectionDelayTime :=
    EStrToDouble(PhysicsReconnectionDelayEdit.Text,
    PasAI.Net.C4.C40_PhysicsReconnectionDelayTime);
  PasAI.Net.C4.C40_UpdateServiceInfoDelayTime :=
    EStrToInt(UpdateServiceInfoTimerEdit.Text, PasAI.Net.C4.C40_UpdateServiceInfoDelayTime);
  PasAI.Net.C4.C40_PhysicsServiceTimeout :=
    EStrToInt(PhysicsServiceTimeoutEdit.Text, PasAI.Net.C4.C40_PhysicsServiceTimeout);
  PasAI.Net.C4.C40_PhysicsTunnelTimeout :=
    EStrToInt(PhysicsTunnelTimeoutEdit.Text, PasAI.Net.C4.C40_PhysicsTunnelTimeout);
  PasAI.Net.C4.C40_KillIDCFaultTimeout :=
    EStrToInt(KillIDCFaultTimeoutEdit.Text, PasAI.Net.C4.C40_KillIDCFaultTimeout);
  PasAI.Net.C4.C40_RootPath := RootDirectoryEdit.Text;
  PasAI.Net.C4.C40_Password := passwdEdit.Text;
end;
...
begin
  ...
  begin
    ...
    dpc_arry := phy_tunnel.DependNetworkClientPool.SearchClass(
      PasAI.Net.C4.TC40_Dispatch_Client, True);
    for j := 0 to length(dpc_arry) - 1 do
      L.MergeAndUpdateWorkload(PasAI.Net.C4.TC40_Dispatch_Client(
  ...
  begin
    ...
    dps_arry := phy_serv.DependNetworkServicePool.GetFromClass(
      PasAI.Net.C4.TC40_Dispatch_Service);
    for j := 0 to length(dps_arry) - 1 do
      L.MergeAndUpdateWorkload(PasAI.Net.C4.TC40_Dispatch_Service(
...
begin
  ...
  try
    ...
    PasAI.Net.C4.C40WriteConfig(cs.Config);
    cs.Config.SetDefaultValue('Root', PasAI.Net.C4.C40_RootPath);
    cs.Config.SetDefaultValue('Password', PasAI.Net.C4.C40_Password);
    ...
    begin
      ...
      begin
        PasAI.Net.C4.C40ReadConfig(cs.Config);
        PasAI.Net.C4.C40_RootPath :=
          cs.Config.GetDefaultValue('Root', PasAI.Net.C4.C40_RootPath);
        if not umlDirectoryExists(PasAI.Net.C4.C40_RootPath) then
          umlCreateDirectory(PasAI.Net.C4.C40_RootPath);
        PasAI.Net.C4.C40_Password :=
          cs.Config.GetDefaultValue('Password', PasAI.Net.C4.C40_Password);
