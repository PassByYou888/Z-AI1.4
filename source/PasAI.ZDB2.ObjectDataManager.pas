...
{ ****************************************************************************** }
unit PasAI.ZDB2.ObjectDataManager;
...
{$ENDIF FPC}
  ...
  PasAI.ZDB, PasAI.ZDB.ObjectData_LIB,
  PasAI.ZDB2, PasAI.Cipher, PasAI.ListEngine;

type
  TZDB2_List_ObjectDataManager = class;
  TZDB2_ObjectDataManager = class;
  TZDB2_Big_List_ObjectDataManager_Decl__ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TZDB2_ObjectDataManager>;
