...
type
  ...
  public var
    ...
    constructor Create(AInputStream: TCore_Stream; AOutputStream: TCore_Stream);
    ...
    function fillinbuff(fil: TCore_Stream): Byte;
    procedure myputc(c: Byte);
    procedure FlushBuff;
    procedure fclose(fil: TCore_Stream);
    function ftell(fil: TCore_Stream): Int64;
    function mygetc: Int;
    procedure myungetc(x: Byte; fil: TCore_Stream);
...
procedure TJLSBitIO.fclose(fil: TCore_Stream);
begin

end;

function TJLSBitIO.ftell(fil: TCore_Stream): Int64;
begin
  Result := fil.Position;
end;
...
function TJLSBitIO.fillinbuff(fil: TCore_Stream): Byte;
var
  i: Int;
begin
...
procedure TJLSBitIO.myungetc(x: Byte; fil: TCore_Stream);
begin
  dec(FP);
  buff^[FP] := x;
...
constructor TJLSBitIO.Create(AInputStream, AOutputStream: TCore_Stream);
begin
