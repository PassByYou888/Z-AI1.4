...
{$ENDIF FPC}
  PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.Status, PasAI.MemoryStream, PasAI.ListEngine,
  PasAI.ZDB.ObjectData_LIB, PasAI.ZDB, PasAI.ZDB.ItemStream_LIB,
  PasAI.HashList.Templet, PasAI.DFE, PasAI.ZDB2, PasAI.IOThread, PasAI.Cipher;
...
type
  ...
  TZDB2_FI_Pool_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TZDB2_FI>;
