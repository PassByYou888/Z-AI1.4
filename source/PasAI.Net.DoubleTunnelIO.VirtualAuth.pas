...
{$ENDIF FPC}
  ...
  private
    ...
    r_fileSize: Int64;
    r_fileMD5: PasAI.UnicodeMixedLib.TMD5;
    l_fileMD5: PasAI.UnicodeMixedLib.TMD5;
    ...
    procedure DoResult_GetFileMD5(const UserData: Pointer; const UserObject: TCore_Object; const fileName: SystemString; const StartPos, EndPos: Int64; const MD5: PasAI.UnicodeMixedLib.TMD5);
  public
    constructor Create;
    destructor Destroy; override;
  end;
...
procedure TAutomatedDownloadFile_Struct_VirtualAuth.DoResult_GetFileMD5(const UserData: Pointer; const UserObject: TCore_Object;
  const fileName: SystemString; const StartPos, EndPos: Int64; const MD5: PasAI.UnicodeMixedLib.TMD5);
begin
  r_fileMD5 := MD5;
