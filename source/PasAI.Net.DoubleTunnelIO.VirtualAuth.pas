...
unit PasAI.Net.DoubleTunnelIO.VirtualAuth;
...
{$ENDIF FPC}
  PasAI.Core,
  PasAI.ListEngine, PasAI.UnicodeMixedLib,
  PasAI.DFE, PasAI.MemoryStream, PasAI.Net, PasAI.Net.PhysicsIO,
  PasAI.TextDataEngine,
  PasAI.Status, PasAI.Cadencer, PasAI.Notify, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.Cipher;
...
type
  ...
  public
    RecvTunnel: TService_RecvTunnel_UserDefine_VirtualAuth;
  ...
  protected
    ...
    procedure UserLoginSuccess(UserDefineIO: TService_RecvTunnel_UserDefine_VirtualAuth); virtual;
    procedure UserLinkSuccess(UserDefineIO: TService_RecvTunnel_UserDefine_VirtualAuth); virtual;
    procedure UserOut(UserDefineIO: TService_RecvTunnel_UserDefine_VirtualAuth); virtual;
    procedure UserPostFileSuccess(UserDefineIO: TService_RecvTunnel_UserDefine_VirtualAuth; fn: SystemString); virtual;
  protected
  ...
  public
    ...
    function GetUserDefineRecvTunnel(RecvCli: TPeerIO): TService_RecvTunnel_UserDefine_VirtualAuth;
  ...
  TClient_SendTunnel_VirtualAuth = class;
  ...
  public
    ...
    SendTunnel: TClient_SendTunnel_VirtualAuth;
  ...
  public
    Client: TDTClient_VirtualAuth;
    RecvTunnel: TClient_RecvTunnel_VirtualAuth;
...
{$ENDIF FPC}
  ...
  TDT_P2PVM_VirtualAuth_Custom_Client_Clone_Pool_ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TDT_P2PVM_VirtualAuth_Custom_Client>;
  ...
  private
    ...
    r_fileSize: Int64;
    r_fileMD5: PasAI.Core.TMD5;
    l_fileMD5: PasAI.Core.TMD5;
    ...
    procedure DoResult_GetFileMD5(const UserData: Pointer; const UserObject: TCore_Object; const fileName: SystemString; const StartPos, EndPos: Int64; const MD5: PasAI.Core.TMD5);
  public
    constructor Create;
    destructor Destroy; override;
  end;
...
procedure TAutomatedDownloadFile_Struct_VirtualAuth.DoResult_GetFileMD5(const UserData: Pointer; const UserObject: TCore_Object;
  const fileName: SystemString; const StartPos, EndPos: Int64; const MD5: PasAI.Core.TMD5);
begin
  r_fileMD5 := MD5;
