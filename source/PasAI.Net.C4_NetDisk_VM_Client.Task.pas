...
{ ****************************************************************************** }
unit PasAI.Net.C4_NetDisk_VM_Client.Task;
...
type
  ...
  TC40_NetDisk_VM_Client_Task_List = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TC40_NetDisk_VM_Client_Task>;
