...
unit PasAI.MemoryRaster.JPEG.Huffman;

{$I PasAI.Define.inc}

interface

uses PasAI.Core, PasAI.MemoryStream, PasAI.MemoryRaster.JPEG.Type_LIB, PasAI.MemoryRaster.JPEG.BitStream;
...
type
  ...
  TEntropyCoderList = class(TCore_ObjectList)
  private
  ...
  public
    procedure DecodeMcuBlock(var Block_: TMCUBlock; Reader_: TBitReader; ZigZag_: PZigZagArray);
...
procedure TACBaselineHuffmanDecoder.DecodeMcuBlock(var Block_: TMCUBlock; Reader_: TBitReader; ZigZag_: PZigZagArray);
var
