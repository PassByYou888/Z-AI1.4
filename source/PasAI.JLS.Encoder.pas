...
uses
  PasAI.JLS.Global, PasAI.Core, PasAI.JLS.BitIO, StrUtils, SysUtils, PasAI.JLS.Jpegmark, PasAI.JLS.Melcode, PasAI.JLS.Lossless, PasAI.JLS.BaseCodec;
...
type
  ...
  private
    ...
    procedure read_one_line(Line: ppixel; Cols: Int; infile: TCore_Stream);
...
procedure TJLSEncoder.read_one_line(Line: ppixel; Cols: Int; infile: TCore_Stream);
var
  line8: PByte;
  i: Int;
begin
...
var
  stream: TCore_Stream;
begin
  stream := TCore_FileStream.Create(aFileName, fmCreate);
  try
