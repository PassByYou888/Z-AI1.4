...
{$ENDIF FPC}
  PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.Core;
...
type
  ...
  TEvent_Pool___Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<PEvent_Struct__>;
  ...
  TText_Queue_Data_Pool___Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<PText_Queue_Data>;
  ...
  TNo_Ln_Text_Pool___Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<PNo_Ln_Text>;
