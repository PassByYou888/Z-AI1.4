...
{$IFDEF DEBUG}
  SyncObjs,
{$ENDIF DEBUG}
  PasAI.IntXLib_GlobalSettings,
  PasAI.IntXLib_Settings,
  PasAI.IntXLib_Enums,
...
{$ENDIF DEBUG}
  strict private
    ...
    procedure InitFromDigits(digits: TIntXLibUInt32Array; negative: Boolean; mlength: UInt32);
  public
    ...
    constructor Create(digits: TIntXLibUInt32Array; negative: Boolean); overload;
    ...
    /// <exception cref="EArgumentNilException"><paramref name="digits" /> is a null reference.</exception>
    constructor Create(digits: TIntXLibUInt32Array; negative: Boolean; mlength: UInt32); overload;
    ...
    class function Multiply(int1: TIntX; int2: TIntX; mode: TMultiplyMode): TIntX; static;
    ...
    class function Divide(int1: TIntX; int2: TIntX; mode: TDivideMode): TIntX; static;
    ...
    class function Modulo(int1: TIntX; int2: TIntX; mode: TDivideMode): TIntX; static;
    ...
    /// <returns>Division result.</returns>
    class function DivideModulo(int1: TIntX; int2: TIntX; out modRes: TIntX): TIntX; overload; static;
    ...
    /// <param name="mode">Divide mode.</param>
    /// <returns>Division result.</returns>
    class function DivideModulo(int1: TIntX; int2: TIntX; out modRes: TIntX; mode: TDivideMode): TIntX; overload; static;
    ...
    class function IntegerLogN(base: TIntX; number: TIntX): TIntX; overload; static;
    ...
    class function ModPow(value: TIntX; exponent: TIntX; modulus: TIntX): TIntX; static;
    ...
    /// <exception cref="EArgumentNilException"><paramref name="int1" /> is a null reference.</exception>
    /// <exception cref="EArgumentNilException"><paramref name="int2" /> is a null reference.</exception>
    class function Bezoutsidentity(int1: TIntX; int2: TIntX; out bezOne: TIntX; out bezTwo: TIntX): TIntX; static;
    ...
    /// <exception cref="EArgumentNilException"><paramref name="value" /> is a null reference.</exception>
    class function IsProbablyPrime(value: TIntX; Accuracy: Integer = 5): Boolean; static;
    ...
    /// <returns>Number in given power.</returns>
    class function Pow(value: TIntX; power: UInt32; multiplyMode: TMultiplyMode): TIntX; overload; static;
    ...
    /// <returns>Object string representation.</returns>
    function ToString(numberBase: UInt32; const alphabet: String): String; overload;
    ...
    /// <param name="numberBase">Number base.</param>
    /// <returns>Parsed TIntX object.</returns>
    class function Parse(const value: String; numberBase: UInt32): TIntX; overload; static;
    ...
    /// <param name="alphabet">Alphabet which contains chars used to represent big integer, char position is coresponding digit value.</param>
    /// <returns>Parsed TIntX object.</returns>
    class function Parse(const value: String; numberBase: UInt32; const alphabet: String): TIntX; overload; static;
    ...
    /// <returns>Parsed TIntX object.</returns>
    class function Parse(const value: String; mode: TParseMode): TIntX; overload; static;
    ...
    /// <param name="mode">Parse mode.</param>
    /// <returns>Parsed TIntX object.</returns>
    class function Parse(const value: String; numberBase: UInt32; mode: TParseMode): TIntX; overload; static;
    ...
    /// <param name="mode">Parse mode.</param>
    /// <returns>Parsed TIntX object.</returns>
    class function Parse(const value: String; numberBase: UInt32; const alphabet: String; mode: TParseMode): TIntX; overload; static;
    ...
    procedure GetInternalState(out digits: TIntXLibUInt32Array; out negative: Boolean; out zeroinithelper: Boolean);
    ...
    class function CompareRecords(Rec1: TIntX; Rec2: TIntX): Boolean; static; inline;
...
uses
  ...
  PasAI.IntXLib_DivideManager,
  PasAI.IntXLib_StringConvertManager,
  PasAI.IntXLib_ParseManager,
  PasAI.IntXLib_DigitHelper,
  PasAI.IntXLib_OpHelper,
...
begin
  ...
  if (IsInfinite(value)) then
      raise EOverflowException.Create(PasAI.IntXLib_Strings.Overflow_TIntXInfinity);
  if (IsNaN(value)) then
      raise EOverflowException.Create(PasAI.IntXLib_Strings.Overflow_NotANumber);
  _digits := Nil;
...
begin
  ...
  if CompareRecords(value, Default (TIntX)) then
      raise EArgumentNilException.Create(PasAI.IntXLib_Strings.CantBeNull + ' value');
...
begin
  ...
  if CompareRecords(base, Default (TIntX)) then
      raise EArgumentNilException.Create(PasAI.IntXLib_Strings.CantBeNull + ' base');
  if CompareRecords(number, Default (TIntX)) then
      raise EArgumentNilException.Create(PasAI.IntXLib_Strings.CantBeNull + ' number');

  if ((base = 0) or (number = 0)) then
      raise EArgumentException.Create(PasAI.IntXLib_Strings.LogCantComputeZero);

  if ((base._negative) or (number._negative)) then
      raise EArgumentException.Create(PasAI.IntXLib_Strings.LogNegativeNotAllowed);
...
begin
  ...
  if ((int1._negative) or (int2._negative)) then
      raise EArgumentException.Create(PasAI.IntXLib_Strings.InvModNegativeNotAllowed);
...
begin
  ...
  if modulus <= 0 then
      raise EArgumentException.Create(PasAI.IntXLib_Strings.ModPowModulusCantbeZeroorNegative);

  if (exponent._negative) then
      raise EArgumentException.Create(PasAI.IntXLib_Strings.ModPowExponentCantbeNegative);
...
begin
  ...
  if ((Self._length > 1) or (Self._digits[0] > UInt32(TConstants.MaxIntValue))) then
      raise EOverflowException.Create(PasAI.IntXLib_Strings.OverFlow_Data);
...
procedure TIntX.InitFromDigits(digits: TIntXLibUInt32Array; negative: Boolean; mlength: UInt32);
begin
  _length := mlength;
  SetLength(_digits, _length);
