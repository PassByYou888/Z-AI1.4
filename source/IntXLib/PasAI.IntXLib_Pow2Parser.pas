...
type
  ...
  public
    ...
    function Parse(const value: String; numberBase: UInt32; charToDigits: TDictionary<Char, UInt32>; checkFormat: Boolean): TIntX; overload;
    ...
    function Parse(const value: String; startIndex: Integer; endIndex: Integer; numberBase: UInt32; charToDigits: TDictionary<Char, UInt32>; digitsRes: TIntXLibUInt32Array): UInt32; overload;
  end;

implementation

function TPow2Parser.Parse(const value: String; numberBase: UInt32; charToDigits: TDictionary<Char, UInt32>; checkFormat: Boolean): TIntX;
begin
...
function TPow2Parser.Parse(const value: String; startIndex: Integer; endIndex: Integer; numberBase: UInt32; charToDigits: TDictionary<Char, UInt32>; digitsRes: TIntXLibUInt32Array): UInt32;
var
...
begin
  ...
  while i <= (endIndex) do
    begin
      ...
      if initialShift < 0 then
          digitsRes[digitIndex] := digitsRes[digitIndex] or (digit shr - initialShift)
      else
          digitsRes[digitIndex] := digitsRes[digitIndex] or (digit shl initialShift);
