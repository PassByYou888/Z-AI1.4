...
type
  ...
  public
    ...
    function Parse(const value: String; startIndex: Integer; endIndex: Integer; numberBase: UInt32; charToDigits: TDictionary<Char, UInt32>; digitsRes: TIntXLibUInt32Array): UInt32; override;
  end;
...
function TFastParser.Parse(const value: String; startIndex: Integer; endIndex: Integer; numberBase: UInt32; charToDigits: TDictionary<Char, UInt32>; digitsRes: TIntXLibUInt32Array): UInt32;
var
  newLength, initialLength, valueLength, digitsLength, loLength, hiLength, innerStep, outerStep, realLength: UInt32;
  valueDigits, valueDigits2, tempDigits: TIntXLibUInt32Array;
  valueDigitsStartPtr, valueDigitsStartPtr2, valueDigitsPtr, valueDigitsPtr2, tempPtr, ptr1, ptr2, valueDigitsPtrEnd, baseDigitsPtr: PCardinal;
  valueStartPtr, valuePtr, valueEndPtr: PChar;
  multiplier: IIMultiplier;
  baseInt: TIntX;
begin
  newLength := Inherited Parse(value, startIndex, endIndex, numberBase, charToDigits, digitsRes);
  ...
  if (initialLength < TConstants.FastParseLengthLowerBound) then
    begin
      result := F_classicParser.Parse(value, startIndex, endIndex, numberBase, charToDigits, digitsRes);
      Exit;
    end;
  ...
  while valuePtr <= (valueEndPtr) do
    begin
      ...
      valueDigitsPtr^ := TStrRepHelper.GetDigit(charToDigits, valuePtr^, numberBase);
  ...
  TDigitHelper.SetBlockDigits(valueDigitsStartPtr2 + valueLength, digitsLength - valueLength, 0);
        ...
        begin
          ...
          if (hiLength <> 0) then
            begin
              ...
              hiLength := multiplier.Multiply(baseDigitsPtr, baseInt._length, ptr1 + innerStep, hiLength, ptr2);
