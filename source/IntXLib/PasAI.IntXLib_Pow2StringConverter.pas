...
unit PasAI.IntXLib_Pow2StringConverter;
...
type
  ...
  public
    ...
    function ToString(IntX: TIntX; numberBase: UInt32; alphabet: TIntXLibCharArray): String; reintroduce; overload;
    ...
    function ToString(digits: TIntXLibUInt32Array; mlength: UInt32; numberBase: UInt32; var outputLength: UInt32): TIntXLibUInt32Array; reintroduce; overload;
  end;

implementation

function TPow2StringConverter.ToString(IntX: TIntX; numberBase: UInt32; alphabet: TIntXLibCharArray): String;
begin
  result := '';
  Exit;
end;

function TPow2StringConverter.ToString(digits: TIntXLibUInt32Array; mlength: UInt32; numberBase: UInt32; var outputLength: UInt32): TIntXLibUInt32Array;
var
...
begin
  ...
  digitsBitLength := UInt64(mlength - 1) * TConstants.DigitBitCount + UInt64(TBits.Msb(digits[mlength - 1])) + UInt64(1);
      ...
      if (initialShift >= nextDigitShift) then
        begin
          ...
          if ((initialShift <> nextDigitShift) and (digitIndex < mlength)) then
            begin
              outputDigit := outputDigit or (digits[digitIndex] shl (TConstants.DigitBitCount - initialShift));
            end;
