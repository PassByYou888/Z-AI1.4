...
unit PasAI.IntXLib_FastStringConverter;
...
type
  ...
  public
    ...
    constructor Create(pow2StringConverter: IIStringConverter; mclassicStringConverter: IIStringConverter);
...
constructor TFastStringConverter.Create(pow2StringConverter: IIStringConverter; mclassicStringConverter: IIStringConverter);
begin
...
function TFastStringConverter.ToString(digits: TIntXLibUInt32Array; mlength: UInt32; numberBase: UInt32; var outputLength: UInt32): TIntXLibUInt32Array;
var
  outputArray, resultArray, resultArray2, tempBuffer, tempArray: TIntXLibUInt32Array;
  ...
  baseInt: TIntX;
  resultPtr1Const, resultPtr2Const, tempBufferPtr, resultPtr1, resultPtr2, tempPtr, ptr1, ptr2, ptr1end, baseIntPtr, outputPtr: PCardinal;
begin
