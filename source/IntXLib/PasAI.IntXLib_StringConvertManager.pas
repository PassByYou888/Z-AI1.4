...
unit PasAI.IntXLib_StringConvertManager;
...
uses
  ...
  PasAI.IntXLib_Enums,
  PasAI.IntXLib_ClassicStringConverter,
  PasAI.IntXLib_FastStringConverter,
  PasAI.IntXLib_Pow2StringConverter,
  PasAI.IntXLib_Types;
...
type
  ...
  public
    ...
    class function GetStringConverter(mode: TToStringMode): IIStringConverter; static;
...
begin
  ...
  mclassicStringConverter := TClassicStringConverter.Create(Pow2StringConverter);

  // Fill publicity visible converter fields
  FClassicStringConverter := mclassicStringConverter;
  FFastStringConverter := TFastStringConverter.Create(Pow2StringConverter, mclassicStringConverter);
end;

class function TStringConvertManager.GetStringConverter(mode: TToStringMode): IIStringConverter;
begin
  case (mode) of
