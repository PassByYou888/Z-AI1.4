...
unit PasAI.IntXLib_StringConverterBase;
...
type
  ...
  public
    ...
    function ToString(IntX: TIntX; numberBase: UInt32; alphabet: TIntXLibCharArray): String; reintroduce; overload; virtual;
    ...
    function ToString(digits: TIntXLibUInt32Array; mlength: UInt32; numberBase: UInt32; var outputLength: UInt32): TIntXLibUInt32Array; reintroduce; overload; virtual;
  end;
...
function TStringConverterBase.ToString(IntX: TIntX; numberBase: UInt32; alphabet: TIntXLibCharArray): String;
var
...
begin
  ...
  if ((numberBase < 2) or (numberBase > 65536)) then
    begin
      raise EArgumentException.Create(PasAI.IntXLib_Strings.ToStringSmallBase + ' numberBase');
    end;
...
function TStringConverterBase.ToString(digits: TIntXLibUInt32Array; mlength: UInt32; numberBase: UInt32; var outputLength: UInt32): TIntXLibUInt32Array;
begin
