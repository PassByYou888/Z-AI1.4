...
uses
  ...
  PasAI.IntXLib_PcgRandomMinimal,
  PasAI.IntXLib_MillerRabin,
  PasAI.IntXLib_Utils,
  PasAI.IntXLib_Types,
  PasAI.IntXLib;
...
type
  ...
  public
    ...
    class function AddSub(int1: TIntX; int2: TIntX; subtract: Boolean): TIntX; static;
    ...
    class function Pow(value: TIntX; power: UInt32; multiplyMode: TMultiplyMode): TIntX; static;
    ...
    class function Cmp(int1: TIntX; int2: TIntX; throwNullException: Boolean): Integer; overload; static;
    ...
    class function Sh(IntX: TIntX; shift: Int64; toLeft: Boolean): TIntX; static;
    ...
    /// </remarks>
    class procedure GetDoubleParts(mdbl: Double; out sign: Integer; out exp: Integer; out man: UInt64; out fFinite: Boolean); static;
    ...
    /// Source : Microsoft .NET Reference on GitHub
    /// </remarks>
    class function GetDoubleFromParts(sign: Integer; exp: Integer; man: UInt64): Double; static;
    ...
    /// Source : Microsoft .NET Reference on GitHub
    /// </remarks>
    class procedure SetDigitsFromDouble(value: Double; var digits: TIntXLibUInt32Array; out newInt: TIntX);
  end;
...
class function TOpHelper.AddSub(int1: TIntX; int2: TIntX; subtract: Boolean): TIntX;
begin
  // Exceptions
...
class function TOpHelper.Pow(value: TIntX; power: UInt32; multiplyMode: TMultiplyMode): TIntX;
var
  msb: Integer;
...
begin
  // Exception
  if (value < 0) then
      raise EArgumentException.Create(Format(PasAI.IntXLib_Strings.NegativeFactorial,
...
class function TOpHelper.ModPow(value: TIntX; exponent: TIntX; modulus: TIntX): TIntX;
begin
  result := 1;
...
class function TOpHelper.Bezoutsidentity(int1: TIntX; int2: TIntX; out bezOne: TIntX; out bezTwo: TIntX): TIntX;
var
  s, t, r, old_s, old_t, old_r, quotient, prov: TIntX;
begin

  if int1._negative then
      raise EArgumentNilException.Create(PasAI.IntXLib_Strings.BezoutNegativeNotAllowed
      + ' int1');
  ...
  if (int1 = 0) or (int2 = 0) then
      raise EArgumentException.Create(PasAI.IntXLib_Strings.BezoutNegativeCantComputeZero);
...
class function TOpHelper.IsProbablyPrime(value: TIntX; Accuracy: Integer = 5): Boolean;
begin
...
class function TOpHelper.Cmp(int1: TIntX; int2: TIntX; throwNullException: Boolean): Integer;
var
  ...
  if (isNull1 or isNull2) then
    begin
      if (throwNullException) then
        begin
          if isNull1 then
              raise EArgumentNilException.Create(PasAI.IntXLib_Strings.CantBeNullCmp + ' int1')
          else if isNull2 then
              raise EArgumentNilException.Create(PasAI.IntXLib_Strings.CantBeNullCmp + ' int2')
        end
...
begin
  ...
  if TIntX.CompareRecords(IntX, Default (TIntX)) then
    ...
    begin
      raise EArgumentNilException.Create(PasAI.IntXLib_Strings.CantBeNullOne + ' intX');
    end;
  ...
  if (toLeft and (newBitCount > TConstants.MaxBitCount)) then
    begin
      raise EArgumentException.Create(PasAI.IntXLib_Strings.IntegerTooBig + ' intX');
    end;
...
class procedure TOpHelper.GetDoubleParts(mdbl: Double; out sign: Integer; out exp: Integer; out man: UInt64; out fFinite: Boolean);
var
  du: TDoubleUlong;
begin
...
class function TOpHelper.GetDoubleFromParts(sign: Integer; exp: Integer; man: UInt64): Double;
var
  du: TDoubleUlong;
  cbitShift: Integer;
begin
...
class procedure TOpHelper.SetDigitsFromDouble(value: Double; var digits: TIntXLibUInt32Array; out newInt: TIntX);
var
