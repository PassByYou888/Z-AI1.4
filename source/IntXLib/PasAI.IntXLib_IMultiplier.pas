...
unit PasAI.IntXLib_IMultiplier;
...
type
  ...
  IIMultiplier = interface(IInterface)
    ...
    function Multiply(digits1: TIntXLibUInt32Array; length1: UInt32; digits2: TIntXLibUInt32Array; length2: UInt32; digitsRes: TIntXLibUInt32Array): UInt32; overload;
    ...
    function Multiply(digitsPtr1: PCardinal; length1: UInt32; digitsPtr2: PCardinal; length2: UInt32; digitsResPtr: PCardinal): UInt32; overload;
  end;
