...
unit PasAI.IntXLib_IStringConverter;
...
type
  ...
  IIStringConverter = interface(IInterface)
    ...
    function ToString(IntX: TIntX; numberBase: UInt32; alphabet: TIntXLibCharArray): String; overload;
    ...
    function ToString(digits: TIntXLibUInt32Array; mlength: UInt32; numberBase: UInt32; var outputLength: UInt32): TIntXLibUInt32Array; overload;
  end;
