...
unit PasAI.IntXLib_GlobalSettings;
...
type
  ...
  public
    ...
    /// </summary>
    property MultiplyMode: TMultiplyMode read GetMultiplyMode write SetMultiplyMode;
    /// <summary>
    ...
    /// </summary>
    property ToStringMode: TToStringMode read GetToStringMode write SetToStringMode;
    /// <summary>
    ...
    /// </summary>
    property ApplyFhtValidityCheck: Boolean read GetApplyFhtValidityCheck write SetApplyFhtValidityCheck;
  end;
