...
unit PasAI.IntXLib_DividerBase;
...
type
  ...
  public
    ...
    function DivMod(int1: TIntX; int2: TIntX; out modRes: TIntX; resultFlags: TDivModResultFlags): TIntX; overload; virtual;
    ...
    function DivMod(digits1: TIntXLibUInt32Array;
      ...
      resultFlags: TDivModResultFlags; cmpResult: Integer): UInt32; overload; virtual; abstract;
    ...
    function DivMod(digitsPtr1: PCardinal; digitsBufferPtr1: PCardinal;
      ...
      length2: UInt32; digitsResPtr: PCardinal; resultFlags: TDivModResultFlags; cmpResult: Integer): UInt32; overload; virtual;
