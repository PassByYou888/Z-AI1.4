...
type
  ...
  private
    ...
    class procedure FhtButterfly(slice1: PDouble; slice2: PDouble; index1: UInt32; index2: UInt32; Cos: Double; Sin: Double); static;
    ...
    /// <param name="Cos">Cos value.</param>
    /// <param name="Sin">Sin value.</param>
    class procedure ReverseFhtButterfly(slice1: PDouble; slice2: PDouble; index1: UInt32; index2: UInt32; Cos: Double; Sin: Double); static;
    ...
    /// <param name="Cos">Cos value.</param>
    /// <param name="Sin">Sin value.</param>
    class procedure ReverseFhtButterfly2(slice1: PDouble; slice2: PDouble; index1: UInt32; index2: UInt32; Cos: Double; Sin: Double); static;
    ...
    class procedure GetInitialTrigValues(valuesPtr: PTrigValues; lengthLog2: Integer);
  ...
  public
    ...
    class function ConvertDigitsToDouble(digits: TIntXLibUInt32Array; mlength: UInt32; newLength: UInt32): TIntXLibDoubleArray; overload; static;
    ...
    /// <param name="newLength">Multiplication result length (must be pow of 2).</param>
    /// <returns>Double array.</returns>
    class function ConvertDigitsToDouble(digitsPtr: PCardinal; mlength: UInt32; newLength: UInt32): TIntXLibDoubleArray; overload; static;
    ...
    class procedure ConvertDoubleToDigits(marray: TIntXLibDoubleArray; mlength: UInt32; digitsLength: UInt32; digitsRes: TIntXLibUInt32Array); overload; static;
    ...
    class procedure ConvertDoubleToDigits(slice: PDouble; mlength: UInt32; digitsLength: UInt32; digitsResPtr: PCardinal); overload; static;
    ...
    class procedure Fht(marray: TIntXLibDoubleArray; mlength: UInt32); overload; static;
    ...
    class procedure Fht(slice: PDouble; mlength: UInt32; lengthLog2: Integer); overload; static;
    ...
    class procedure MultiplyFhtResults(data: TIntXLibDoubleArray; data2: TIntXLibDoubleArray; mlength: UInt32); overload; static;
    ...
    /// <param name="mlength">FHT results length.</param>
    class procedure MultiplyFhtResults(slice: PDouble; slice2: PDouble; mlength: UInt32); overload; static;
    ...
    /// <param name="marray">Double array.</param>
    /// <param name="mlength">Array length.</param>
    class procedure ReverseFht(marray: TIntXLibDoubleArray; mlength: UInt32); overload; static;
    ...
    /// <param name="mlength">Slice length.</param>
    /// <param name="lengthLog2">Log2(<paramref name="mlength" />).</param>
    class procedure ReverseFht(slice: PDouble; mlength: UInt32; lengthLog2: Integer); overload; static;
...
class function TFhtHelper.ConvertDigitsToDouble(digits: TIntXLibUInt32Array; mlength: UInt32; newLength: UInt32): TIntXLibDoubleArray;
var
  digitsPtr: PCardinal;
begin
  digitsPtr := @digits[0];
...
class function TFhtHelper.ConvertDigitsToDouble(digitsPtr: PCardinal; mlength: UInt32; newLength: UInt32): TIntXLibDoubleArray;
var
...
class procedure TFhtHelper.ConvertDoubleToDigits(marray: TIntXLibDoubleArray; mlength: UInt32; digitsLength: UInt32; digitsRes: TIntXLibUInt32Array);
var
  slice: PDouble;
...
class procedure TFhtHelper.ConvertDoubleToDigits(slice: PDouble; mlength: UInt32; digitsLength: UInt32; digitsResPtr: PCardinal);
var
  normalizeMultiplier, carry, dataDigit: Double;
{$IFDEF DEBUG}
...
class procedure TFhtHelper.Fht(slice: PDouble; mlength: UInt32; lengthLog2: Integer);
var
  rightSlice: PDouble;
...
begin
  ...
  while i < (lengthDiv4) do
    begin
      FhtButterfly(slice, rightSlice, i, mlength - i, trigValues.Cos, trigValues.Sin);
  ...
  // Final "butterfly"
  FhtButterfly(slice, rightSlice, lengthDiv4, mlength - lengthDiv4, Sqrt2Div2, Sqrt2Div2);
...
class procedure TFhtHelper.MultiplyFhtResults(data: TIntXLibDoubleArray; data2: TIntXLibDoubleArray; mlength: UInt32);
var
...
class procedure TFhtHelper.MultiplyFhtResults(slice: PDouble; slice2: PDouble; mlength: UInt32);
var
...
class procedure TFhtHelper.ReverseFht(marray: TIntXLibDoubleArray; mlength: UInt32);
var
  slice: PDouble;
begin
  slice := @marray[0];
...
class procedure TFhtHelper.ReverseFht(slice: PDouble; mlength: UInt32; lengthLog2: Integer);
var
  rightSlice: PDouble;
  lengthDiv2, lengthDiv4, i: UInt32;
  trigValues: TTrigValues;
begin
  ...
  // Final "butterfly"
  ReverseFhtButterfly(slice, rightSlice, lengthDiv4, mlength - lengthDiv4, Sqrt2Div2, Sqrt2Div2);
...
class procedure TFhtHelper.FhtButterfly(slice1: PDouble; slice2: PDouble; index1: UInt32; index2: UInt32; Cos: Double; Sin: Double);
var
  d11, d12, temp: Double;
begin
  d11 := slice1[index1];
...
class procedure TFhtHelper.ReverseFhtButterfly(slice1: PDouble; slice2: PDouble; index1: UInt32; index2: UInt32; Cos: Double; Sin: Double);
var
...
class procedure TFhtHelper.ReverseFhtButterfly2(slice1: PDouble; slice2: PDouble; index1: UInt32; index2: UInt32; Cos: Double; Sin: Double);
var
  temp, temp2: Double;
begin
  temp := slice1[index1];
...
class procedure TFhtHelper.GetInitialTrigValues(valuesPtr: PTrigValues; lengthLog2: Integer);
