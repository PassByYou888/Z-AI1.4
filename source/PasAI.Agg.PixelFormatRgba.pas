...
(*
  ...
  ////////////////////////////////////////////////////////////////////////////////
*)
unit PasAI.Agg.PixelFormatRgba;
...
{$I PasAI.Agg.PixelFormatBgra32.inc}
...
{$I PasAI.Agg.PixelFormatRgba32.inc}
...
{$I PasAI.Agg.PixelFormatArgb32.inc}
...
{$I PasAI.Agg.PixelFormatAbgr32.inc}
...
{$I PasAI.Agg.PixelFormatBgra32Pre.inc}
...
{$I PasAI.Agg.PixelFormatRgba32Pre.inc}
...
{$I PasAI.Agg.PixelFormatArgb32Pre.inc}
...
{$I PasAI.Agg.PixelFormatAbgr32Pre.inc}
...
{$I PasAI.Agg.PixelFormatAlpha32.inc}
...
{$I PasAI.Agg.PixelFormatCubl32.inc}
...
function Sd_min(a, b: Cardinal): Cardinal;
begin
  if a < b then
      Result := a
  else
...
function Sd_max(a, b: Cardinal): Cardinal;
begin
  if a > b then
      Result := a
  else
