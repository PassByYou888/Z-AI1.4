...
{$ELSE FPC}
  System.IOUtils,
{$ENDIF FPC}
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.Status, PasAI.UnicodeMixedLib, PasAI.ListEngine, PasAI.Parsing,
  PasAI.Geometry2D, PasAI.DFE, PasAI.Json,
  PasAI.Notify, PasAI.Cipher, PasAI.MemoryStream,
  PasAI.Expression, PasAI.OpCode,
  PasAI.ZDB2, PasAI.ZDB2.Thread.Queue, PasAI.ZDB2.Thread,
...
{$ENDIF FPC}
  ...
  TC4_Help_Console_Command_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TC4_Help_Console_Command_Data>;
...
C40_PhysicsClientClass := PasAI.Net.PhysicsIO.TPhysicsClient;
