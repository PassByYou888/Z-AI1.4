...
type
  ...
  TLFloat_List_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TGenericsList<TLFloat>;
  ...
  TLFloat_BigList_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TLFloat>;
  ...
  TLI_List_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TGenericsList<TLInt>;
  ...
  TLI_BigList_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TLInt>;
