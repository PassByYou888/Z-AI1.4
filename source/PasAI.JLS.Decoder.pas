...
uses
  ...
  PasAI.JLS.Global, PasAI.JLS.Jpegmark, PasAI.JLS.BitIO, PasAI.JLS.Melcode, PasAI.JLS.Lossless, PasAI.JLS.Lossy, PasAI.JLS.BaseCodec;
...
type
  ...
  public
    ...
    procedure write_one_line(Line: ppixel; Cols: Int; outfile: TCore_Stream);
...
procedure TJLSDecoder.write_one_line(Line: ppixel; Cols: Int; outfile: TCore_Stream);
var
  i, index: Integer;
  maptable: pwordarray;
  line8: TBytes;
