...
{ ****************************************************************************** }
unit PasAI.Net.C4_NetDisk_Directory;
...
{$ENDIF FPC}
  ...
  PasAI.ZDB2, PasAI.ZDB2.ObjectDataManager, PasAI.ZDB2.DFE,
...
{$ENDIF FPC}
  ...
  TCopyItem_Info_Tool_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TCopyItem_Info>;
  ...
  TCopyField_Info_Tool_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TCopyField_Info>;
...
begin
  ...
  Directory_ZDB2_Password := ParamList.GetDefaultValue('Directory_Password', PasAI.Net.C4.C40_Password);
...
{$ENDIF C4_Safe_Flush}
  ...
  MD5_ZDB2_Password := ParamList.GetDefaultValue('MD5_Password', PasAI.Net.C4.C40_Password);
