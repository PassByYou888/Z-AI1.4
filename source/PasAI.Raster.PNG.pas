...
uses PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.MemoryStream, PasAI.MemoryRaster, PasAI.Geometry2D;

function IsPNG(const Stream: TCore_Stream): Boolean;
procedure LoadPasAI_RasterFromPNG(raster: TMPasAI_Raster; Stream: TCore_Stream);
procedure SavePasAI_RasterToPNG(raster: TMPasAI_Raster; Stream: TCore_Stream);
...
{$ENDIF}
  ...
  public
    procedure ReadFromStream(Stream: TCore_Stream; ChunkSize: Cardinal); virtual;
    procedure WriteToStream(Stream: TCore_Stream); virtual;
  ...
  protected
    ...
    procedure AssignTo(Dest: TCore_Persistent); override;
  public
    constructor Create; virtual;

    procedure ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal); override;
    procedure WriteToStream(Stream: TCore_Stream); override;
  ...
  public
    ...
    property Data: TMS64 read FData;
  end;
  ...
  public
    ...
    procedure ReadFromStream(Stream: TCore_Stream); virtual; abstract;
    procedure WriteToStream(Stream: TCore_Stream); virtual; abstract;
  ...
  public
    ...
    procedure ReadFromStream(Stream: TCore_Stream); override;
    procedure WriteToStream(Stream: TCore_Stream); override;
  ...
  protected
    function GetChunkSize: Cardinal; virtual; abstract;
  public
    procedure ReadFromStream(Stream: TCore_Stream); virtual;
    procedure WriteToStream(Stream: TCore_Stream); virtual;
  ...
  public
    constructor Create(Stream: TCore_Stream; Header: TChunkPngImageHeader;
  ...
  private
    ...
    function CalculateCRC(Stream: TCore_Stream): Cardinal; overload;
{$IFDEF CheckCRC}
    function CheckCRC(Stream: TCore_Stream; CRC: Cardinal): Boolean;
{$ENDIF CheckCRC}
    procedure ReadImageDataChunk(Stream: TCore_Stream; Size: TGeoInt);
    procedure ReadUnknownChunk(Stream: TCore_Stream; ChunkName: TChunkName; ChunkSize_: TGeoInt);
  ...
  protected
    ...
    procedure CopyImageData(Stream: TCore_Stream);
    procedure StoreImageData(Stream: TCore_Stream);
    procedure DecompressImageDataToStream(Stream: TCore_Stream);
    procedure CompressImageDataFromStream(Stream: TCore_Stream);
  ...
  public
    ...
    class function CanLoad(Stream: TCore_Stream): Boolean; overload;
...
function ReadPNGStringFromStream(Stream: TCore_Stream; L: Integer): TPascalString; forward;
procedure WritePNGStringToStream(s: TPascalString; Stream: TCore_Stream); forward;
...
function ReadPNGStringFromStream(Stream: TCore_Stream; L: Integer): TPascalString;
var
  i: TGeoInt;
  tmp: TBytes;
begin
...
procedure WritePNGStringToStream(s: TPascalString; Stream: TCore_Stream);
var
  tmp: TBytes;
  tmp_end: Byte;
begin
...
function ReadSwappedWord(Stream: TCore_Stream): Word;
begin
...
function ReadSwappedSmallInt(Stream: TCore_Stream): SmallInt;
begin
{$IFDEF ValidateEveryReadOperation}
...
function ReadSwappedCardinal(Stream: TCore_Stream): Cardinal;
begin
{$IFDEF ValidateEveryReadOperation}
...
procedure WriteSwappedWord(Stream: TCore_Stream; Value: Word);
begin
  Value := Swap16(Value);
  Stream.Write(Value, SizeOf(Word));
end;

procedure WriteSwappedSmallInt(Stream: TCore_Stream; Value: SmallInt);
begin
  Value := Swap16(Value);
  Stream.Write(Value, SizeOf(SmallInt));
end;

procedure WriteSwappedCardinal(Stream: TCore_Stream; Value: Cardinal);
begin
  Value := Swap32(Value);
...
procedure ZCompress(Data: Pointer; Size: TGeoInt; const Output: TCore_Stream; Level: TGeoInt); overload;
const
  CBufferSize = $8000;
var
...
procedure ZCompress(const Input: TMS64; const Output: TCore_Stream; Level: TGeoInt); overload;
begin
  ZCompress(Input.Memory, Input.Size, Output, Level);
end;

procedure ZDecompress(Data: Pointer; Size: TGeoInt; const Output: TCore_Stream); overload;
const
  CBufferSize = $8000;
var
  ZStreamRecord: TZStreamRec;
...
procedure ZDecompress(const Input: TMS64; const Output: TCore_Stream); overload;
begin
...
procedure TCustomPngTransparency.ReadFromStream(Stream: TCore_Stream);
begin

end;

procedure TCustomPngTransparency.WriteToStream(Stream: TCore_Stream);
begin

end;

procedure TCustomChunk.ReadFromStream(Stream: TCore_Stream;
  ChunkSize: Cardinal);
begin

end;

procedure TCustomChunk.WriteToStream(Stream: TCore_Stream);
begin
...
procedure TChunkPngUnknown.AssignTo(Dest: TCore_Persistent);
begin
  inherited;
...
procedure TChunkPngUnknown.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
begin
  with Stream do
    begin
...
procedure TChunkPngUnknown.WriteToStream(Stream: TCore_Stream);
begin
  with Stream do
    begin
      FDataStream.Position := 0;
...
procedure TChunkPngImageHeader.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngImageHeader.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
begin
  with Stream do
    begin
...
procedure TChunkPngImageHeader.WriteToStream(Stream: TCore_Stream);
begin
  with Stream do
    begin
      // write width
...
procedure TCustomDefinedChunkWithHeader.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngPalette.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngPalette.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
begin
  with Stream do
    begin
...
procedure TChunkPngPalette.WriteToStream(Stream: TCore_Stream);
begin
  if ChunkSize > 0 then
...
procedure TChunkPngTransparency.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngTransparency.ReadFromStream(Stream: TCore_Stream;
  ChunkSize_: Cardinal);
begin
  if Assigned(FTransparency) then
...
procedure TChunkPngTransparency.WriteToStream(Stream: TCore_Stream);
begin
  // check consistency
  case FHeader.ColorType of
...
procedure TPngTransparencyFormat0.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngTransparencyFormat0.ReadFromStream(Stream: TCore_Stream);
begin
  inherited;
...
procedure TPngTransparencyFormat0.WriteToStream(Stream: TCore_Stream);
begin
  inherited;
...
procedure TPngTransparencyFormat2.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngTransparencyFormat2.ReadFromStream(Stream: TCore_Stream);
begin
  inherited;
...
procedure TPngTransparencyFormat2.WriteToStream(Stream: TCore_Stream);
begin
  inherited;
...
procedure TPngTransparencyFormat3.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngTransparencyFormat3.ReadFromStream(Stream: TCore_Stream);
begin
  inherited;
...
procedure TPngTransparencyFormat3.WriteToStream(Stream: TCore_Stream);
begin
  inherited;
...
procedure TChunkPngPhysicalPixelDimensions.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngPhysicalPixelDimensions.ReadFromStream(Stream: TCore_Stream;
  ChunkSize_: Cardinal);
begin
  with Stream do
    begin
...
procedure TChunkPngPhysicalPixelDimensions.WriteToStream(Stream: TCore_Stream);
begin
  with Stream do
    begin
...
procedure TChunkPngPhysicalScale.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngPhysicalScale.ReadFromStream(Stream: TCore_Stream;
  ChunkSize_: Cardinal);
begin
  with Stream do
    begin
...
procedure TChunkPngPhysicalScale.WriteToStream(Stream: TCore_Stream);
begin
  raise EPngError.Create(RCStrNotYetImplemented);
  // yet todo, see http://www.libpng.org/pub/png/book/chapter11.html#png.ch11.div.9
end;

procedure TChunkPngImageOffset.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngImageOffset.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
begin
  with Stream do
    begin
      if (ChunkSize_ > Size) or (GetChunkSize > ChunkSize_) then
...
procedure TChunkPngImageOffset.WriteToStream(Stream: TCore_Stream);
begin
...
procedure TChunkPngPixelCalibrator.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngPixelCalibrator.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
begin
  with Stream do
    begin
      // read keyword
...
procedure TChunkPngPixelCalibrator.WriteToStream(Stream: TCore_Stream);
begin
  inherited;

end;

procedure TCustomChunkPngText.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngText.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
var
  Index: TGeoInt;
  tmp: TBytes;
begin
...
procedure TChunkPngText.WriteToStream(Stream: TCore_Stream);
var
  tmp: TBytes;
begin
  // write keyword
...
procedure TChunkPngCompressedText.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngCompressedText.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
var
  DataIn: Pointer;
  DataInSize: TGeoInt;
  Output: TMS64;
...
procedure TChunkPngCompressedText.WriteToStream(Stream: TCore_Stream);
var
  OutputStream: TMS64;
  tmp: TBytes;
begin
...
procedure TChunkPngInternationalText.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngInternationalText.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
var
  Index: TGeoInt;
begin
  inherited;
...
procedure TChunkPngInternationalText.WriteToStream(Stream: TCore_Stream);
begin
  raise EPngError.Create(RCStrNotYetImplemented);
end;
...
procedure TChunkPngImageData.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngImageData.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
begin
  inherited;
...
procedure TChunkPngImageData.WriteToStream(Stream: TCore_Stream);
begin
  FData.Seek(0, TSeekOrigin.soBeginning);
  Stream.CopyFrom(FData, FData.Size);
end;

procedure TChunkPngTime.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngTime.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
begin
  with Stream do
    begin
      if (ChunkSize_ > Size) or (GetChunkSize > ChunkSize_) then
...
procedure TChunkPngTime.WriteToStream(Stream: TCore_Stream);
begin
  with Stream do
    begin
      // write year
...
procedure TChunkPngEmbeddedIccProfile.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngEmbeddedIccProfile.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
begin
  with Stream do
    begin
      // read keyword
...
procedure TChunkPngEmbeddedIccProfile.WriteToStream(Stream: TCore_Stream);
begin
  with Stream do
    begin
      // write keyword
...
procedure TChunkPngGamma.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngGamma.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
begin
  with Stream do
    begin
      if (ChunkSize_ > Size) or (GetChunkSize > ChunkSize_) then
...
procedure TChunkPngGamma.WriteToStream(Stream: TCore_Stream);
begin
  with Stream do
    begin
      // write gamma
...
procedure TChunkPngStandardColorSpaceRGB.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngStandardColorSpaceRGB.ReadFromStream(Stream: TCore_Stream;
  ChunkSize_: Cardinal);
begin
  with Stream do
    begin
...
procedure TChunkPngStandardColorSpaceRGB.WriteToStream(Stream: TCore_Stream);
begin
...
procedure TChunkPngPrimaryChromaticities.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngPrimaryChromaticities.ReadFromStream(Stream: TCore_Stream;
  ChunkSize_: Cardinal);
begin
  with Stream do
    begin
...
procedure TChunkPngPrimaryChromaticities.WriteToStream(Stream: TCore_Stream);
begin
  with Stream do
    begin
...
procedure TPngSignificantBitsFormat0.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngSignificantBitsFormat0.ReadFromStream(Stream: TCore_Stream);
begin
  Stream.Read(FGrayBits, 1);
end;

procedure TPngSignificantBitsFormat0.WriteToStream(Stream: TCore_Stream);
begin
...
procedure TPngSignificantBitsFormat23.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngSignificantBitsFormat23.ReadFromStream(Stream: TCore_Stream);
begin
...
procedure TPngSignificantBitsFormat23.WriteToStream(Stream: TCore_Stream);
begin
...
procedure TPngSignificantBitsFormat4.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngSignificantBitsFormat4.ReadFromStream(Stream: TCore_Stream);
begin
  Stream.Read(FGrayBits, 1);
  Stream.Read(FAlphaBits, 1);
end;

procedure TPngSignificantBitsFormat4.WriteToStream(Stream: TCore_Stream);
begin
  Stream.Write(FGrayBits, 1);
...
procedure TPngSignificantBitsFormat6.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngSignificantBitsFormat6.ReadFromStream(Stream: TCore_Stream);
begin
  Stream.Read(FRedBits, 1);
  Stream.Read(FGreenBits, 1);
  Stream.Read(FBlueBits, 1);
...
procedure TPngSignificantBitsFormat6.WriteToStream(Stream: TCore_Stream);
begin
  Stream.Write(FRedBits, 1);
  Stream.Write(FGreenBits, 1);
  Stream.Write(FBlueBits, 1);
...
procedure TChunkPngSignificantBits.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngSignificantBits.ReadFromStream(Stream: TCore_Stream;
  ChunkSize_: Cardinal);
begin
  if Assigned(FSignificantBits) then
    begin
...
procedure TChunkPngSignificantBits.WriteToStream(Stream: TCore_Stream);
begin
  if Assigned(FSignificantBits) then
      FSignificantBits.WriteToStream(Stream);
end;

procedure TPngBackgroundColorFormat04.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngBackgroundColorFormat04.ReadFromStream(Stream: TCore_Stream);
begin
  FGraySampleValue := ReadSwappedWord(Stream);
end;

procedure TPngBackgroundColorFormat04.WriteToStream(Stream: TCore_Stream);
begin
  WriteSwappedWord(Stream, FGraySampleValue);
end;

procedure TPngBackgroundColorFormat26.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngBackgroundColorFormat26.ReadFromStream(Stream: TCore_Stream);
begin
  FRedSampleValue := ReadSwappedWord(Stream);
  FGreenSampleValue := ReadSwappedWord(Stream);
  FBlueSampleValue := ReadSwappedWord(Stream);
...
procedure TPngBackgroundColorFormat26.WriteToStream(Stream: TCore_Stream);
begin
  WriteSwappedWord(Stream, FRedSampleValue);
  WriteSwappedWord(Stream, FGreenSampleValue);
  WriteSwappedWord(Stream, FBlueSampleValue);
...
procedure TPngBackgroundColorFormat3.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TPngBackgroundColorFormat3.ReadFromStream(Stream: TCore_Stream);
begin
  Stream.Read(FIndex, 1);
end;

procedure TPngBackgroundColorFormat3.WriteToStream(Stream: TCore_Stream);
begin
  Stream.Write(FIndex, 1);
end;

procedure TChunkPngBackgroundColor.AssignTo(Dest: TCore_Persistent);
begin
...
procedure TChunkPngBackgroundColor.ReadFromStream(Stream: TCore_Stream;
  ChunkSize_: Cardinal);
begin
  if Assigned(FBackground) then
    begin
...
procedure TChunkPngBackgroundColor.WriteToStream(Stream: TCore_Stream);
begin
  if Assigned(FBackground) then
...
procedure TChunkPngImageHistogram.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
var
  Index: TGeoInt;
begin
  // check size
...
procedure TChunkPngImageHistogram.WriteToStream(Stream: TCore_Stream);
var
  Index: TGeoInt;
begin
...
procedure TChunkPngSuggestedPalette.ReadFromStream(Stream: TCore_Stream; ChunkSize_: Cardinal);
var
  Index: TGeoInt;
  DataSize: TGeoInt;
begin
...
procedure TChunkPngSuggestedPalette.WriteToStream(Stream: TCore_Stream);
begin
  raise EPngError.Create(RCStrNotYetImplemented);
...
procedure TChunkList.AssignTo(Dest: TCore_Persistent);
var
  Index: TGeoInt;
...
constructor TCustomPngCoder.Create(Stream: TCore_Stream;
...
constructor TCustomPngTranscoder.Create(Stream: TCore_Stream;
  Header: TChunkPngImageHeader; Gamma: TChunkPngGamma = nil;
  Palette: TChunkPngPalette = nil; Transparency: TCustomPngTransparency = nil);
begin
  inherited;
...
procedure TPortableNetworkGraphic.CopyImageData(Stream: TCore_Stream);
var
  DataIndex: TGeoInt;
begin
...
procedure TPortableNetworkGraphic.StoreImageData(Stream: TCore_Stream);
var
...
procedure TPortableNetworkGraphic.DecompressImageDataToStream(Stream: TCore_Stream);
var
  DataStream: TMS64;
begin
  DataStream := TMS64.Create;
  try
...
procedure TPortableNetworkGraphic.CompressImageDataFromStream(Stream: TCore_Stream);
var
  DataStream: TMS64;
begin
  DataStream := TMS64.Create;
  try
    ...
    if Stream is TMS64 then
        ZCompress(TMS64(Stream), DataStream, FCompressionLevel)
    else
        raise EPngError.Create(RCStrNotYetImplemented);
...
class function TPortableNetworkGraphic.CanLoad(Stream: TCore_Stream): Boolean;
var
...
procedure TPortableNetworkGraphic.LoadFromStream(Stream: TCore_Stream);
var
...
procedure TPortableNetworkGraphic.SaveToStream(Stream: TCore_Stream);
var
  ChunkName: TChunkName;
  ChunkSize_: Cardinal;
  CRC: Cardinal;
...
procedure TPortableNetworkGraphic.ReadUnknownChunk(Stream: TCore_Stream;
...
procedure TPortableNetworkGraphic.ReadImageDataChunk(Stream: TCore_Stream; Size: TGeoInt);
var
...
procedure TPortableNetworkGraphic.Assign(Source: TCore_Persistent);
begin
...
procedure TPortableNetworkGraphic.AssignTo(Dest: TCore_Persistent);
begin
...
function TPortableNetworkGraphic.CalculateCRC(Stream: TCore_Stream): Cardinal;
var
  CrcValue: Cardinal;
  Value: Byte;
begin
  if Stream is TMS64 then
      Result := CalculateCRC(TMS64(Stream).Memory, Stream.Size)
  else
    with Stream do
      begin
...
function TPortableNetworkGraphic.CheckCRC(Stream: TCore_Stream; CRC: Cardinal): Boolean;
begin
...
type
  ...
  private
    procedure AssignPropertiesFromRaster(raster: TMPasAI_Raster);
  ...
  public
    ...
    procedure DrawToRaster(raster: TMPasAI_Raster); virtual;
...
procedure TPortableNetworkMemoryRaster.AssignPropertiesFromRaster(raster: TMPasAI_Raster);
var
...
begin
  if raster is TMPasAI_Raster then
      Result := TMPasAI_Raster(raster).ScanLine[Y]
  else
      Result := nil;
end;
...
procedure TPortableNetworkMemoryRaster.AssignTo(Dest: TCore_Object);
begin
  if Dest is TMPasAI_Raster then
    begin
      TMPasAI_Raster(Dest).SetSize(ImageHeader.Width, ImageHeader.Height, 0);
      DrawToRaster(TMPasAI_Raster(Dest));
    end;
end;

procedure TPortableNetworkMemoryRaster.Assign(Source: TCore_Object);
var
  EncoderClass: TCustomPngEncoderClass;
  DataStream: TMS64;
begin
  if Source is TMPasAI_Raster then
    with TMPasAI_Raster(Source) do
      begin
        // Assign
        AssignPropertiesFromRaster(TMPasAI_Raster(Source));
        ...
        with DataStream do
          try
            with EncoderClass.Create(DataStream, FImageHeader, FGammaChunk, FPaletteChunk) do
              begin
                try
                    EncodeFromScanline(TMPasAI_Raster(Source), {$IFDEF FPC}@{$ENDIF FPC}RasterScanline);
                finally
                    Free;
                end;
              end;
...
begin
  ...
  Result := True;
  TempRaster := TMPasAI_Raster.Create;
  try
    AssignTo(TempRaster);
...
procedure TPortableNetworkMemoryRaster.DrawToRaster(raster: TMPasAI_Raster);
var
...
constructor TCustomPngNonInterlacedDecoder.Create(Stream: TCore_Stream;
...
constructor TCustomPngAdam7Decoder.Create(Stream: TCore_Stream;
  Header: TChunkPngImageHeader; Gamma: TChunkPngGamma;
  Palette: TChunkPngPalette; Transparency: TCustomPngTransparency);
begin
  inherited;
...
constructor TCustomPngNonInterlacedEncoder.Create(Stream: TCore_Stream;
  Header: TChunkPngImageHeader; Gamma: TChunkPngGamma;
  Palette: TChunkPngPalette; Transparency: TCustomPngTransparency);
begin
  inherited;
