...
uses Types,
  PasAI.Core, PasAI.UnicodeMixedLib, PasAI.PascalStrings, PasAI.UPascalStrings,
  PasAI.ListEngine, PasAI.MemoryStream, PasAI.Cipher,
  PasAI.Status, PasAI.Geometry.Low, PasAI.TextDataEngine, PasAI.Geometry2D, PasAI.Geometry3D,
  PasAI.Json, PasAI.Number,
{$IFDEF FPC}
...
uses SysUtils, Variants, PasAI.Notify;
