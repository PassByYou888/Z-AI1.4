...
{$ENDIF FPC}
  ...
  PasAI.Notify, PasAI.ZDB2.Thread.Queue;
...
type
  ...
  TZDB2_Th_Engine_Data_Instance_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TZDB2_Th_Engine_Data>;
  TZDB2_Th_Engine_Data_BigList___ = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TZDB2_Th_Engine_Data>;
  TZDB2_Th_Engine_Marshal_BigList___ = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TZDB2_Th_Engine_Data>;
  TZDB2_Th_Engine_Data_Instance_Recycle_Tool___ = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TZDB2_Th_Engine_Data>;
  TZDB2_Th_Engine_Data_Link_Recycle_Tool___ = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TZDB2_Th_Engine_Data>;
  TZDB2_Th_Engine_Static_Copy_Instance_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TZDB2_Th_Engine_Static_Copy_Tech>;
  TZDB2_Th_Engine_Dynamic_Copy_Instance_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TZDB2_Th_Engine_Dynamic_Copy_Tech>;
...
{$ENDIF FPC}
  ...
  TZDB2_Th_Engine_Data_List = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TZDB2_Th_Engine_Data>;
...
{$REGION 'Thread_Engine'}
  ...
  TZDB2_Th_Engine_Pool_ = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TZDB2_Th_Engine>;
...
{$REGION 'Engine_Marshal'}
  ...
  TZDB2_Th_Engine_Marshal_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TZDB2_Th_Engine_Marshal>;
...
type
  ...
  TFileTime_Sort_Tool = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TFile_Time_Info>;
