{ ****************************************************************************** }
{ * draw engine for FMX(optimized)                                             * }
{ ****************************************************************************** }
unit PasAI.DrawEngine.FMX;
...
{$ENDIF}
  PasAI.Geometry3D, PasAI.ListEngine,
  PasAI.PascalStrings,
  PasAI.Core, PasAI.DrawEngine, PasAI.UnicodeMixedLib, PasAI.Geometry2D, PasAI.MemoryRaster;
...
{$ENDIF}
  ...
  TResourceTextureIntf = class(TCore_InterfacedObject)
  public
  ...
  TResourceTextureCache = class(TCore_Object)
  protected
...
uses PasAI.Status, PasAI.MemoryStream, PasAI.MediaCenter;
