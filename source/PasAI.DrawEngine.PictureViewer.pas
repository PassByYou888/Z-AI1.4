...
{ * picture viewer tool                                                        * }
{ ****************************************************************************** }
unit PasAI.DrawEngine.PictureViewer;
...
type
  ...
  public
    ...
    constructor Create(Parent_: TRasterHistogramInfos; PasAI_Raster_: TMPasAI_Raster; MorphPix_: TMorphologyPixel; Height_: Integer; hColor: TRColor);
  ...
  public
    ...
    constructor Create(Parent_: TPictureViewerData; PasAI_Raster_: TMPasAI_Raster);
    destructor Destroy; override;
    procedure Update;
  ...
  public
    ...
    procedure WaitThread;
    function InputPicture(Raster: TMPasAI_Raster; Instance_, AutoFree_: Boolean): TPictureViewerData; overload;
    function InputPicture(Raster: TMPasAI_Raster; Instance_: Boolean): TPictureViewerData; overload;
    function InputPicture(Raster: TMPasAI_Raster; TexInfo: U_String; Instance_: Boolean): TPictureViewerData; overload;
    function InputPicture(Raster: TMPasAI_Raster; TexInfo: U_String; Instance_, ShowHistogramInfo_: Boolean): TPictureViewerData; overload;
    function InputPicture(Raster: TMPasAI_Raster; TexInfo: U_String; Instance_, ShowHistogramInfo_, AutoFree_: Boolean): TPictureViewerData; overload;
    ...
    function FoundPicture(Raster: TMPasAI_Raster): TPictureViewerData;
    ...
    property BackgroundTex: TMPasAI_Raster read FBackgroundTex;
    // viewer style
...
begin
  p := thSender.UserData;
  MorphData := p^.PasAI_Raster_.BuildMorphomatics(p^.MorphPix_);
...
begin
  p := thSender.UserData;
  p^.PasAI_Raster_.BuildMorphomaticsTo(p^.MorphPix_, MorphData);
...
constructor TRasterHistogramInfo.Create(Parent_: TRasterHistogramInfos; PasAI_Raster_: TMPasAI_Raster; MorphPix_: TMorphologyPixel; Height_: Integer; hColor: TRColor);
{$IFDEF Parallel}
var
  p: PRasterHistogramThData;
{$ENDIF Parallel}
...
{$ELSE Parallel}
    MorphData := PasAI_Raster_.BuildMorphomatics(MorphPix_);
...
{$IFDEF Parallel}
  new(p);
  p^.PasAI_Raster_ := Parent.Parent.Raster;
  p^.MorphPix_ := MorphPix_;
  p^.Height_ := Height_;
  p^.hColor := hColor;
...
constructor TRasterHistogramInfos.Create(Parent_: TPictureViewerData; PasAI_Raster_: TMPasAI_Raster);
begin
  inherited Create;
  Parent := Parent_;
  SetLength(GrayAndYIQ, 4);
  GrayAndYIQ[0] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpGrayscale, 100, RColor($7F, $7F, $7F));
  GrayAndYIQ[1] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpYIQ_Y, 100, RColor($7F, $7F, $7F));
  GrayAndYIQ[2] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpYIQ_I, 100, RColor($A0, $20, $F0));
  GrayAndYIQ[3] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpYIQ_Q, 100, RColor($00, $FF, $FF));

  SetLength(HSI, 3);
  HSI[0] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpHSI_H, 100, RColor($FF, $7F, $7F));
  HSI[1] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpHSI_S, 100, RColor($00, $7F, $7F));
  HSI[2] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpHSI_I, 100, RColor($7F, $7F, $7F));

  SetLength(CMYK, 4);
  CMYK[0] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpCMYK_C, 100, RColor($00, $FF, $FF));
  CMYK[1] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpCMYK_M, 100, RColor($E4, $00, $7F));
  CMYK[2] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpCMYK_Y, 100, RColor($FF, $DA, $B9));
  CMYK[3] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpCMYK_K, 100, RColor($7F, $7F, $7F));

  SetLength(RGBA, 4);
  RGBA[0] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpR, 100, RColor($FF, $7F, $7F));
  RGBA[1] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpG, 100, RColor($7F, $FF, $7F));
  RGBA[2] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpB, 100, RColor($7F, $7F, $FF));
  RGBA[3] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpA, 100, RColor($7F, $7F, $7F));

  SetLength(Approximate, 5);
  Approximate[0] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpApproximateBlack, 100, RColor($7F, $7F, $7F));
  Approximate[1] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpApproximateWhite, 100, RColor($7F, $F, $7F));
  Approximate[2] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpCyan, 100, RColor($7F, $7F, $7F));
  Approximate[3] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpMagenta, 100, RColor($7F, $7F, $7F));
  Approximate[4] := TRasterHistogramInfo.Create(Self, PasAI_Raster_, TMorphologyPixel.mpYellow, 100, RColor($7F, $7F, $7F));
end;
...
begin
  ...
  FBackgroundTex := NewPasAI_Raster();
...
function TPictureViewerInterface.InputPicture(Raster: TMPasAI_Raster; Instance_, AutoFree_: Boolean): TPictureViewerData;
begin
...
function TPictureViewerInterface.InputPicture(Raster: TMPasAI_Raster; Instance_: Boolean): TPictureViewerData;
begin
  Result := InputPicture(Raster, '', Instance_, True);
end;

function TPictureViewerInterface.InputPicture(Raster: TMPasAI_Raster; TexInfo: U_String; Instance_: Boolean): TPictureViewerData;
begin
  Result := InputPicture(Raster, TexInfo, Instance_, True);
end;

function TPictureViewerInterface.InputPicture(Raster: TMPasAI_Raster; TexInfo: U_String; Instance_, ShowHistogramInfo_: Boolean): TPictureViewerData;
begin
  Result := InputPicture(Raster, TexInfo, Instance_, ShowHistogramInfo_, False);
end;

function TPictureViewerInterface.InputPicture(Raster: TMPasAI_Raster; TexInfo: U_String; Instance_, ShowHistogramInfo_, AutoFree_: Boolean): TPictureViewerData;
var
...
function TPictureViewerInterface.FoundPicture(Raster: TMPasAI_Raster): TPictureViewerData;
var
  i: Integer;
begin
  for i := 0 to Count - 1 do
