...
uses
  ...
  {$I Include\PasAI.OverbyteIcsWinsockTypes.inc}
{$ENDIF MSWINDOWS}
...
uses
    ...
    {$I Include\PasAI.OverbyteIcsDotNetSockTypes.inc}
{$ENDIF CLR}

implementation
{$IFDEF MSWINDOWS}
  {$I Include\PasAI.OverbyteIcsWinsockImpl.inc}
...
{$IFDEF CLR}
    {$I Include\PasAI.OverbyteIcsDotNetSockImpl.inc}
{$ENDIF}
