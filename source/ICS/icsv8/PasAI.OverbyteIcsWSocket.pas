...
{$WARN UNIT_PLATFORM ON}
  ...
  PasAI.Ics.Posix.KEventTypes,
  PasAI.Ics.Posix.KEventApi,
...
{$I Include\PasAI.Ics.InterlockedApi.inc}
...
begin
{$IFDEF MSWINDOWS}
    PasAI.OverbyteIcsWinsock.ForceLoadWinsock;
{$ENDIF}
(*
{$IFDEF MSWINDOWS}
...
begin
{$IFDEF MSWINDOWS}
    PasAI.OverbyteIcsWinsock.CancelForceLoadWinsock;
{$ENDIF}
(*
{$IFDEF MSWINDOWS}
    _EnterCriticalSection(GWSockCritSect);
...
begin
{$IFDEF MSWINDOWS}
    PasAI.OverbyteIcsWinsock.UnloadWinsock;
{$ENDIF}
end;
...
function WinsockInfo : TWSADATA;
begin
    Result := PasAI.OverbyteIcsWinsock.WinsockAPIInfo;
end;
