...
{$ENDIF}
    ...
    PasAI.OverbyteIcsCRC,        { angus V7.7 }
    PasAI.OverbyteIcsMD5,        { angus V7.7 }
    PasAI.OverbyteIcsUtils,
    PasAI.OverbyteIcsStreams;    { angus V7.7 }
...
begin
    Result := PasAI.OverbyteIcsUtils.IcsGetLocalTimeZoneBias;
end;
