...
Apr 25, 2016 V8.04 Angus Moved TextToHtmlText and RemoveHtmlSpecialChars here from
                    OverbyteIcsHttpSrv to hare with others units
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
unit PasAI.OverbyteIcsFormDataDecoder;
...
const
    FormDataDecoderVersion = 850;
    CopyRight : String      = ' FormDataDecoder (c) 2003-2017 F. Piette V8.50 ';
