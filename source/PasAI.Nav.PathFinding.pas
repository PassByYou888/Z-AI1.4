...
type
  ...
  TNavStepFinding = class(TCore_Persistent)
  private
...
procedure Level1OptimizationPath(CM: TPolyPassManager; ignore: TCore_ListForObj; APath: TVec2List; ARadius: TGeoFloat);
procedure Level2OptimizationPath(CM: TPolyPassManager; ignore: TCore_ListForObj; APath: TVec2List; ARadius: TGeoFloat; LowLap: Boolean);
procedure Level3OptimizationPath(CM: TPolyPassManager; ignore: TCore_ListForObj; APath: TVec2List; ARadius: TGeoFloat; LowLap: Boolean);
procedure Level4OptimizationPath(CM: TPolyPassManager; ignore: TCore_ListForObj; APath: TVec2List; ARadius: TGeoFloat; LowLap: Boolean);
