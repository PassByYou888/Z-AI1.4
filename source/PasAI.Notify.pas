...
{$ENDIF FPC}
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.DFE, PasAI.Cadencer;
...
{$ENDIF FPC}
  TN_Post_Execute_List_Struct = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TN_Post_Execute>;
