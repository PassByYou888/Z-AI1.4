...
{$ENDIF FPC}
  PasAI.UnicodeMixedLib, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.Learn.KDTree, PasAI.Learn.Type_LIB, PasAI.MemoryStream, PasAI.DFE,
...
{$ENDIF FPC}
  ...
  TLearn_Memory_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TGenericsList<PLearnMemory>;
  ...
  TCandidate_Distance_Pool_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<PCandidate_Distance_>;

  TCandidate_Distance_Pool = class(TCandidate_Distance_Pool_Decl)
  private
  ...
  TCandidate_Distance_Hash_Pool_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPascalString_Big_Hash_Pair_Pool<TCandidate_Distance_Pool>;
...
uses PasAI.Learn.KM, PasAI.Status, PasAI.Parsing, PasAI.Expression, PasAI.OpCode;
