...
unit PasAI.TextTable;

{$I PasAI.Define.inc}

interface

uses SysUtils, PasAI.Core, PasAI.DFE, PasAI.ListEngine, PasAI.UnicodeMixedLib,
  PasAI.MemoryStream, PasAI.Parsing, PasAI.PascalStrings, PasAI.UPascalStrings;
