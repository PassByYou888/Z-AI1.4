...
uses Math, PasAI.Learn.Type_LIB, PasAI.Learn;

procedure ArrayMove(VDst: PKMFloat; const i11, i12: NativeInt; vSrc: PKMFloat; const i21, i22: NativeInt); overload;
var
  i: NativeInt;
begin
  inc(VDst, i11);
...
procedure ArrayMove(VDst: PKMFloat; const i11, i12: NativeInt; vSrc: PKMFloat; const i21, i22: NativeInt; const f: TKMFloat); overload;
var
  i: NativeInt;
begin
  inc(VDst, i11);
...
procedure ArraySub(VDst: PKMFloat; const i11, i12: NativeInt; vSrc: PKMFloat; const i21, i22: NativeInt);
var
  i: NativeInt;
begin
  inc(VDst, i11);
...
function ArrayDotProduct(v1: PKMFloat; const i11, i12: NativeInt; v2: PKMFloat; const i21, i22: NativeInt): TKMFloat;
var
  i: NativeInt;
begin
  inc(v1, i11);
...
procedure ArrayAdd(VDst: PKMFloat; const i11, i12: NativeInt; vSrc: PKMFloat; const i21, i22: NativeInt);
var
  i: NativeInt;
begin
  inc(VDst, i11);
...
procedure ArrayMul(VOp: PKMFloat; const i1, i2: NativeInt; const f: TKMFloat);
var
  i: NativeInt;
begin
  inc(VOp, i1);
...
procedure CopyMatrix(const a: TKMFloat2DArray; const IS1, IS2, JS1, JS2: NativeInt; var b: TKMFloat2DArray; const ID1, id2, JD1, JD2: NativeInt);
var
  isrc, idst: NativeInt;
begin
...
procedure CopyAndTranspose(const a: TKMFloat2DArray; const IS1, IS2, JS1, JS2: NativeInt; var b: TKMFloat2DArray; const ID1, id2, JD1, JD2: NativeInt);
var
...
procedure DynamicArrayCopy(const Source: TKMBoolArray; var output: TKMBoolArray);
var
  i: NativeInt;
  r: TKMBoolArray;
begin
...
function SelectCenter(const Source: TKMFloat2DArray;
  ...
  var d2: TKMFloatArray; var p: TKMFloatArray; var tmp: TKMFloatArray): Boolean;
var
...
begin
  ...
  while pass <= Restarts do
    begin
      ...
      //
      // Note that for performance reasons centers are stored in ROWS of CT, not in columns.
      // We'll transpose CT in the end and store it in the KArray.
