...
unit PasAI.MemoryRaster.JPEG.Lossless;
...
uses
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.MemoryRaster.JPEG.Type_LIB, PasAI.MemoryRaster.JPEG.Marker;
...
uses PasAI.MemoryRaster.JPEG.Coder, PasAI.MemoryRaster.JPEG.Image_LIB;
