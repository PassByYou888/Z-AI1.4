...
{$ENDIF FPC}
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.Parsing, PasAI.MemoryStream, PasAI.ListEngine,
  PasAI.HashList.Templet, PasAI.ZDB2, PasAI.ZDB2.FileEncoder, PasAI.Cipher,
...
type
  ...
  TThread_RewritePascal_Process_ZDB_File_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TThread_RewritePascal_Process_ZDB_File>;
...
uses PasAI.Json, PasAI.Status, PasAI.UReplace;
