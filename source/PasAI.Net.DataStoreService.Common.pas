...
{ * DataStore Service                                                          * }
{ ****************************************************************************** }
unit PasAI.Net.DataStoreService.Common;

{$I PasAI.Define.inc}

interface

uses Variants, PasAI.Core, PasAI.Net, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.ZDB.Engine, PasAI.ZDB.LocalManager, PasAI.MemoryStream,
  PasAI.DFE;
