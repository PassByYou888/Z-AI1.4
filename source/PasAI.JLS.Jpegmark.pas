...
type
  ...
  public
    ...
    function write_n_bytes(outstrm: TCore_Stream; Value, n: Int): Int;
    function write_2_bytes(outstrm: TCore_Stream; Value: Int): Int;
    function write_marker(outstrm: TCore_Stream; Marker: Int): Int;
    function write_jpegls_frame(outstrm: TCore_Stream; JP: pjpeg_ls_header): Int;
    function write_jpegls_scan(outstrm: TCore_Stream; JP: pjpeg_ls_header): Int;
    function write_jpegls_extmarker(outstrm: TCore_Stream; JP: pjpeg_ls_header; IDtype: Int): Int;
    function write_jpegls_restartmarker(outstrm: TCore_Stream; JP: pjpeg_ls_header): Int;

    { Functions to read markers }
    function read_n_bytes(instrm: TCore_Stream; n: Int): uint;
    function read_marker(instrm: TCore_Stream; mkp: pint): Int;
    function seek_marker(instrm: TCore_Stream; mkp: pint): Int;
    function read_jpegls_frame(instrm: TCore_Stream; JP: pjpeg_ls_header): Int;
    function read_jpegls_scan(instrm: TCore_Stream; JP: pjpeg_ls_header): Int;
    function read_jpegls_extmarker(instrm: TCore_Stream; JP: pjpeg_ls_header): Int;
    function read_jpegls_restartmarker(instrm: TCore_Stream; JP: pjpeg_ls_header): Int;
  end;
...
function TJLSJpegMark.write_n_bytes(outstrm: TCore_Stream; Value, n: Int): Int;
var
  L: Int;
  i: Byte;
begin
...
function TJLSJpegMark.write_2_bytes(outstrm: TCore_Stream; Value: Int): Int;
begin
  Result := write_n_bytes(outstrm, Value, 2);
end;

function TJLSJpegMark.write_marker(outstrm: TCore_Stream; Marker: Int): Int;
...
function TJLSJpegMark.write_jpegls_frame(outstrm: TCore_Stream; JP: pjpeg_ls_header): Int;
var
  i, marker_len,
    bpp, ct: Int;
  SX, SY: Int;
...
function TJLSJpegMark.write_jpegls_scan(outstrm: TCore_Stream; JP: pjpeg_ls_header): Int;
var
  i, marker_len, ct: Int;
...
function TJLSJpegMark.seek_marker(instrm: TCore_Stream; mkp: pint): Int;
...
function TJLSJpegMark.read_n_bytes(instrm: TCore_Stream; n: Int): uint;
...
function TJLSJpegMark.read_marker(instrm: TCore_Stream; mkp: pint): Int;
...
function TJLSJpegMark.read_jpegls_frame(instrm: TCore_Stream; JP: pjpeg_ls_header): Int;
...
function TJLSJpegMark.read_jpegls_scan(instrm: TCore_Stream; JP: pjpeg_ls_header): Int;
var
...
function TJLSJpegMark.read_jpegls_restartmarker(instrm: TCore_Stream; JP: pjpeg_ls_header): Int;
var
  ct: Int;
