...
uses
  PasAI.JLS.Global, PasAI.JLS.Jpegmark, PasAI.JLS.BitIO, PasAI.JLS.Melcode, PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.ListEngine,
  PasAI.JLS.Lossless, PasAI.JLS.Lossy, Math;
...
type
  ...
  protected
    ...
    function GetInputStream: TCore_Stream;
    function GetOutputStream: TCore_Stream;
    procedure SetInputStream(const Value: TCore_Stream);
    procedure SetOutputStream(const Value: TCore_Stream);
  ...
  public
    ...
    property InputStream: TCore_Stream read GetInputStream write SetInputStream;
    property OutputStream: TCore_Stream read GetOutputStream write SetOutputStream;
...
function TJLSBaseCodec.GetInputStream: TCore_Stream;
begin
  Result := FInputStream;
end;
...
function TJLSBaseCodec.GetOutputStream: TCore_Stream;
begin
...
procedure TJLSBaseCodec.SetInputStream(const Value: TCore_Stream);
begin
  FInputStream := Value;
...
procedure TJLSBaseCodec.SetOutputStream(const Value: TCore_Stream);
begin
  FOutputStream := Value;
