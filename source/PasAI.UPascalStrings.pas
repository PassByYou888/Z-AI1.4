...
uses PasAI.Core, PasAI.PascalStrings;
...
{$ELSE FPC}
  USystemChar = PasAI.PascalStrings.SystemChar;
  USystemString = PasAI.PascalStrings.SystemString;
  TUArrayChar = PasAI.PascalStrings.TArrayChar;
  PUSystemString = PasAI.PascalStrings.PSystemString;
  PUPascalString = PasAI.PascalStrings.PPascalString;
{$ENDIF FPC}
...
{$ENDIF}
    ...
    function StrExists(const s: TUPascalString): Boolean; overload;
