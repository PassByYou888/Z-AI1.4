...
{$REGION 'MemoryRaster'}
  ...
  public
    ...
    function ComputeAreaScaleSpace_NoEdge_Clip(clipArea: TRectV2; SS_width, SS_height: TGeoFloat): TRectV2; overload;
  ...
  TMR_List_Hash_Pool___ = {$IFDEF FPC}specialize {$ENDIF FPC} TString_Big_Hash_Pair_Pool<TMR_List>;
  ...
  TMR_2D_Matrix___ = {$IFDEF FPC}specialize {$ENDIF FPC} TGenericsList<TMR_List>;
  ...
  TBytePasAI_RasterList_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TGenericsList<TBytePasAI_Raster>;
...
{$REGION 'Rasterization Vertex'}
  ...
  TPasAI_RasterVertex = class(TCore_Object)
  private type
...
{$REGION 'TFontRaster'}
  ...
  TFontPasAI_RasterList = {$IFDEF FPC}specialize {$ENDIF FPC} TGenericsList<TFontPasAI_Raster>;

  TFontPasAI_Raster = class(TCore_Object)
  public type
...
{$REGION 'Morphomatics'}
  ...
  TMorphomaticsDraw = {$IFDEF FPC}specialize {$ENDIF FPC}TLine_2D_Templet<TMorphomaticsValue>;
...
{$REGION 'Binaryzation'}
  ...
  TMorphologyBinaryzationDraw_ = {$IFDEF FPC}specialize {$ENDIF FPC}TLine_2D_Templet<TBinaryzationValue>;
  TMorphologyBinaryzationDraw = class(TMorphologyBinaryzationDraw_);

  TMorphologyBinaryzationLineHitAnalysis_ = {$IFDEF FPC}specialize {$ENDIF FPC}TLine_2D_Templet<TBinaryzationValue>;
...
{$REGION 'Segmentation'}
  ...
  TMorphologySegmentation = class(TCore_Object)
  private
    FWidth, FHeight: Integer;
...
function PasAI_RasterColor2Gray(const C: TPasAI_RasterColor): Byte;
function PasAI_RasterColor2GrayS(const C: TPasAI_RasterColor): TGeoFloat;
function PasAI_RasterColor2GrayD(const C: TPasAI_RasterColor): Double;
function SetPasAI_RasterColorAlpha(const C: TPasAI_RasterColor; const A: Byte): TRColor;
...
function SetRColorAlpha(const C: TPasAI_RasterColor; const A: Byte): TRColor;
...
procedure SwapBR(var sour: TRColor); overload;
...
NewPasAI_Raster := {$IFDEF FPC}@{$ENDIF FPC}NewPasAI_Raster_;
NewPasAI_RasterFromFile := {$IFDEF FPC}@{$ENDIF FPC}NewPasAI_RasterFromFile_;
NewPasAI_RasterFromStream := {$IFDEF FPC}@{$ENDIF FPC}NewPasAI_RasterFromStream_;
SavePasAI_Raster := {$IFDEF FPC}@{$ENDIF FPC}SavePasAI_Raster_;
