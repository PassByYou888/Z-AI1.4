...
uses PasAI.Status, PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.MemoryStream, PasAI.ListEngine, PasAI.UnicodeMixedLib;
...
{$ENDIF initializationStatus}
  output := TCore_ResourceStream.Create(HInstance, 'FastGBK', RT_RCDATA);
