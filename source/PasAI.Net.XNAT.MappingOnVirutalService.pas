...
{ ****************************************************************************** }
unit PasAI.Net.XNAT.MappingOnVirutalService;
...
{$ENDIF FPC}
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.Status, PasAI.UnicodeMixedLib, PasAI.ListEngine, PasAI.TextDataEngine,
  PasAI.Cipher, PasAI.DFE, PasAI.MemoryStream, PasAI.Net, PasAI.Notify,
  PasAI.HashList.Templet, PasAI.Net.XNAT.Physics;
