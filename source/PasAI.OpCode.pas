...
{$ENDIF FPC}
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.Status, PasAI.ListEngine, PasAI.UnicodeMixedLib, PasAI.HashList.Templet;
...
uses PasAI.Geometry2D, PasAI.Geometry3D, PasAI.DFE;
