...
unit PasAI.MemoryRaster.JPEG.Marker;

{$I PasAI.Define.inc}

interface

uses SysUtils, PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.MemoryStream,
{$IFDEF FPC}
  PasAI.FPC.GenericList,
{$ENDIF FPC}
  PasAI.MemoryRaster.JPEG.Type_LIB, PasAI.MemoryRaster.JPEG.Huffman;
...
function FindJpegMarkerClassList(Marker_: byte; Stream_: TMS64): TJpegMarkerClass;
