...
unit PasAI.Net.Server.CrossSocket;
...
uses SysUtils, Classes,
  PasAI.Net.CrossSocket, PasAI.Net.SocketAPI, PasAI.Net.CrossSocket.Base, PasAI.Net.CrossServer,
  PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.Status,
  PasAI.Net, PasAI.Core, PasAI.UnicodeMixedLib, PasAI.MemoryStream,
  PasAI.DFE;
...
{$IFDEF DEBUG}
  2
{$ELSE DEBUG}
  PasAI.Core.Get_Parallel_Granularity
{$ENDIF DEBUG}
  );
end;
