...
locations.  hWship6Dll is kept so we can unload the Wship6.dll if necessary.
  ...
  if not PasAI.Net.Winsock2.Winsock2Loaded then
  begin
    PasAI.Net.Winsock2.InitializeWinSock;
  end;
  hProcHandle := PasAI.Net.Winsock2.WinsockHandle;
