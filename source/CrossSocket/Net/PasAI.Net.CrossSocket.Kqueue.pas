...
{                                                                              }
{******************************************************************************}
unit PasAI.Net.CrossSocket.Kqueue;
...
var
  ...
  LSent: Integer;
begin
  // 查阅了资料，linux和unix系统级的io函数都会很安静，不会像windows，动不动就给你抛个异常，处于易读性和调试需要，我干掉了改队列缓存操作的try部分
  LConnection := AConnection;
  LKqConnection := LConnection as TKqueueConnection;
