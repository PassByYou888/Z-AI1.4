...
type
  ...
  public
    ...
    destructor Destroy; override;
    procedure Transform(Input: PFFMPEG_Extract_Tool_Codec_Stream_; Output_: TPasAI_Raster; CopyFrame_: Boolean);
  end;
...
procedure TFFMPEG_Extract_Tool_Video_Transform.Transform(Input: PFFMPEG_Extract_Tool_Codec_Stream_; Output_: TPasAI_Raster; CopyFrame_: Boolean);
begin
  if not Ready then
      exit;
  sws_scale(
