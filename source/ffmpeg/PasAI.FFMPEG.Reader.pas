...
uses SysUtils, Classes,
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.MemoryStream, PasAI.ListEngine,
  PasAI.Status,
  PasAI.MemoryRaster, PasAI.FFMPEG;
...
type
  ...
  private
    ...
    function ReadFrame__(Stack_Num_: integer; output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean;
  public
    ...
    function ReadFrame(output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean;
  ...
  TOnVideo_Build_New_Raster = procedure(Sender: TFFMPEG_VideoStreamReader; Raster: TMPasAI_Raster; var Save_To_Pool: Boolean) of object;
...
uses PasAI.h264, PasAI.FFMPEG.Writer, PasAI.Geometry2D;
...
function TFFMPEG_Reader.ReadFrame__(Stack_Num_: integer; output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean;
var
  done: Boolean;
  R: integer;
begin
...
function TFFMPEG_Reader.ReadFrame(output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean;
begin
  try
...
procedure TFFMPEG_VideoStreamReader.DoVideo_Build_New_Raster(Raster: TMPasAI_Raster; var Save_To_Pool: Boolean);
begin
