...
uses SysUtils,
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.ListEngine, PasAI.MemoryStream, PasAI.Status,
...
type
  ...
  public
    ...
    function EncodeRaster(raster: TMPasAI_Raster; var Updated: Integer): Boolean; overload;
    function EncodeRaster(raster: TMPasAI_Raster): Boolean; overload;
    procedure Flush;
...
function Fast_Encode_As_MJPEG(Input: TMPasAI_Raster; output: TMS64): Boolean;
...
function TFFMPEG_Writer.EncodeRaster(raster: TMPasAI_Raster): Boolean;
var
  Updated: Integer;
begin
  Updated := 0;
