...
type
  ...
  TZDB2_Custom_Small_Data_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<Int64>;
  TZDB2_Custom_Medium_Data_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<Int64>;
  TZDB2_Custom_Large_Data_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<Int64>;
