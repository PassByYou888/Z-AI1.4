...
uses
  ...
  winsock, PasAI.diocp_winapi_winsock2,
...
{$ifend}
  ...
  PasAI.utils_hashs,
  {$IFDEF DIOCP_DEBUG}
  PasAI.utils_threadinfo,
  {$ENDIF}
  PasAI.utils_queues, PasAI.utils_locker, PasAI.utils_async, PasAI.utils_fileWriter, PasAI.utils_strings, PasAI.utils_BufferPool;
...
{$ENDIF}
  begin
    ...
    lvRet := PasAI.diocp_winapi_winsock2.WSARecv(FContext.FRawSocket.SocketHandle,
       @FRecvBuffer,
       1,
