 ...
 *     + add signal task
 *)
unit PasAI.diocp_task;

interface

uses
  PasAI.diocp_core_engine, SysUtils, PasAI.utils_queues, Messages, Windows, Classes,
  SyncObjs, PasAI.utils_hashs, PasAI.utils_locker, PasAI.utils_threadinfo;
