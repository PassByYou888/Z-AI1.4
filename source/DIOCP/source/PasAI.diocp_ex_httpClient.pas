unit PasAI.diocp_ex_httpClient;
{*
 *
...
uses
  Classes
  {$IFDEF POSIX}
  , PasAI.diocp_core_rawPosixSocket
  {$ELSE}
  , PasAI.diocp_core_rawWinSocket
  , PasAI.diocp_winapi_winsock2
  , SysConst
  {$ENDIF}
  , SysUtils, PasAI.utils_URL, PasAI.utils_strings, PasAI.diocp_ex_http_common, PasAI.utils_BufferPool;
