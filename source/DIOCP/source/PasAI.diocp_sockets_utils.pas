...
unit PasAI.diocp_sockets_utils;

interface

uses
  Windows, SysUtils, PasAI.diocp_winapi_winsock2, PasAI.diocp_res;
...
begin
  ...
  Result := PasAI.diocp_winapi_winsock2.bind(s, PSockAddr(@sockaddr), SizeOf(sockaddr)) = 0;
end;
