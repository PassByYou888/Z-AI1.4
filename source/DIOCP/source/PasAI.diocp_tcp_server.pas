...
uses
  Classes, PasAI.diocp_sockets_utils, PasAI.diocp_core_engine,
  winsock, PasAI.diocp_winapi_winsock2, PasAI.diocp_res,

{$if CompilerVersion >= 18}
  types,
{$ifend}

  PasAI.diocp_core_rawWinSocket, SyncObjs, Windows, SysUtils,
  PasAI.utils_safeLogger,
  PasAI.utils_hashs,
  PasAI.utils_queues, PasAI.utils_locker, PasAI.utils_strings, PasAI.utils_threadinfo
  
  , PasAI.utils_byteTools
  , PasAI.utils_BufferPool;
...
type
  ...
  private
    ...
    FCounter:Integer;
    FDebugInfo:String;
    FInnerBuffer: PasAI.diocp_winapi_winsock2.TWsaBuf;
    FRecvBuffer: PasAI.diocp_winapi_winsock2.TWsaBuf;
    FRecvdFlag: Cardinal;
    FOwner: TDiocpTcpServer;
...
begin
  //FContextLocker.lock();
  PasAI.utils_strings.SpinLock(FInnerLockerFlag);
end;

procedure TIocpClientContext.InnerUnLock;
begin
  //FContextLocker.unLock;
  PasAI.utils_strings.SpinUnLock(FInnerLockerFlag);
end;
...
begin
  ...
  begin
    ...
    raise Exception.CreateFmt('%s=>(%d,%d)当前对象已经被其他线程正在使用',
       [pvDebugInfo, PasAI.utils_strings.GetCurrentThreadID, FCheckThreadId]);
  end;
  FCheckThreadId := PasAI.utils_strings.GetCurrentThreadID;
...
begin
  ...
  begin
    ...
    lvRet := PasAI.diocp_winapi_winsock2.WSARecv(FClientContext.FRawSocket.SocketHandle,
       @FRecvBuffer,
       1,
