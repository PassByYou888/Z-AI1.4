...
unit PasAI.diocp_udp;

interface

uses
  PasAI.diocp_core_engine, Classes, SysUtils, PasAI.diocp_core_rawWinSocket,
  PasAI.diocp_winapi_winsock2, SyncObjs, Windows, PasAI.utils_locker, PasAI.utils_queues,
  PasAI.utils_hashs, PasAI.utils_safeLogger, PasAI.diocp_res;
...
type
  ...
  private
    ...
    FWSAToAddr: PasAI.diocp_winapi_winsock2.TSockAddrIn;
  ...
  private
    ...
    FWSARecvBuffer    : PasAI.diocp_winapi_winsock2.TWsaBuf;
    FWSARecvFrom      : PasAI.diocp_winapi_winsock2.TSockAddrIn;
    FWSAFromLen       : Integer;
  private
...
begin
  ...
  lvRet := PasAI.diocp_winapi_winsock2.WSARecvFrom(FListener.FRawSocket.SocketHandle,
     @FWSARecvBuffer,
     1,
...
begin
  ...
  FRequestState := rsPosting;
  lvRet := PasAI.diocp_winapi_winsock2.WSASendTo(FSocket,
     @FInnerBuffer,
     1,
     @lpNumberOfBytesRecvd,
     FWSASendFlag,
