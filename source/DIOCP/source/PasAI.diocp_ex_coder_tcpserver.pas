 ...
 *)
unit PasAI.diocp_ex_coder_tcpserver;
...
uses
  PasAI.diocp_tcp_server, PasAI.utils_buffer, SysUtils, Classes,
  PasAI.diocp_coder_baseObject, PasAI.utils_queues, PasAI.utils_locker, PasAI.utils_BufferPool
...
type
  ...
  TIOCPCoderClientContext = class(PasAI.diocp_tcp_server.TIOCPClientContext)
  private
