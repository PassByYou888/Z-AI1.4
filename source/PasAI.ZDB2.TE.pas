...
{$ENDIF FPC}
  ...
  PasAI.TextDataEngine, PasAI.ZDB2, PasAI.Cipher, PasAI.ListEngine;

type
  TZDB2_List_HashTextEngine = class;
  TZDB2_HashTextEngine = class;
  TZDB2_Big_List_HashTextEngine_Decl__ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TZDB2_HashTextEngine>;
