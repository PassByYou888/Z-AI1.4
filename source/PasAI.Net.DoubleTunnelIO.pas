...
{$ENDIF FPC}
  ...
  PasAI.Status, PasAI.Cadencer, PasAI.Notify, PasAI.ZDB.FilePackage_LIB,
  PasAI.ZDB, PasAI.Cipher, PasAI.PascalStrings, PasAI.UPascalStrings;
...
{$ENDIF FPC}
  ...
  TDT_P2PVM_Custom_Client_Clone_Pool_ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TDT_P2PVM_Custom_Client>;
