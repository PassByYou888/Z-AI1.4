...
unit PasAI.Net.DoubleTunnelIO.NoAuth;
...
{$ENDIF FPC}
  ...
  PasAI.TextDataEngine, PasAI.Status, PasAI.Cadencer, PasAI.Notify, PasAI.PascalStrings, PasAI.UPascalStrings;
...
{$ENDIF FPC}
  ...
  TDT_P2PVM_NoAuth_Custom_Client_Clone_Pool_ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TDT_P2PVM_NoAuth_Custom_Client>;
