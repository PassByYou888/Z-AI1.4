{ ****************************************************************************** }
{ * sound engine Bass API                                                      * }
{ ****************************************************************************** }
unit PasAI.Sound.Bass.API;
...
const
  ...
  BASS_ERROR_VERSION  = 43; // invalid Z.Sound.Bass.API version (used by add-ons)
...
{$IFDEF IOS}
      ...
      function BASS_SetEAXPreset(env: Integer): BOOL;
      {
        ...
        It is not part of Z.Sound.Bass.API.DLL but an extra function which makes it easier
...
{$ELSE} // Non IOS
      ...
      function BASS_SetEAXPreset(env: Integer): BOOL;
      {
        ...
        It is not part of Z.Sound.Bass.API.DLL but an extra which makes it easier
        to set the predefined EAX environments.
        env    : a EAX_ENVIRONMENT_xxx constant
      }
      {$ENDIF}
