...
uses PasAI.Core, PasAI.ZDB.ObjectData_LIB, PasAI.UnicodeMixedLib, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.ListEngine, PasAI.ZDB2, PasAI.HashList.Templet;

type
  TItemHandle = PasAI.ZDB.ObjectData_LIB.TItemHandle_;
  PItemHandle = ^TItemHandle;
  TFieldHandle = PasAI.ZDB.ObjectData_LIB.TField;
  PFieldHandle = ^TFieldHandle;
  TItemSearch = PasAI.ZDB.ObjectData_LIB.TSearchItem_;
  PItemSearch = ^TItemSearch;
  TFieldSearch = PasAI.ZDB.ObjectData_LIB.TSearchField_;
  PFieldSearch = ^TFieldSearch;
  TItemRecursionSearch = PasAI.ZDB.ObjectData_LIB.TRecursionSearch_;
  ...
  TItem_Pos_Info_List = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TItem_Pos_Info>;

  TPair_Item_Pos_Info = record
    info1, info2: TItem_Pos_Info;
  end;

  TPair_Item_Pos_Info_List = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TPair_Item_Pos_Info>;
...
var
  FieldHnd: TFieldHandle;
  i: Integer;
  h: PasAI.ZDB.ObjectData_LIB.THeader;
begin
  Result := False;
  SetLength(output, 0);
