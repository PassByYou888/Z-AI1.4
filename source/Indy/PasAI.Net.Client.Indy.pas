...
(*
  update history
*)
unit PasAI.Net.Client.Indy;

{$I ..\PasAI.Define.inc}

interface

uses PasAI.Net, PasAI.Core,
  PasAI.DFE, PasAI.ListEngine, PasAI.MemoryStream,

  Classes, SysUtils,
  IdTCPClient, IdYarn, IdStack,
  IDGlobal, IdBaseComponent, IdComponent, IdTCPConnection, IdContext,
  PasAI.Status, PasAI.UnicodeMixedLib, PasAI.PascalStrings, PasAI.UPascalStrings;
