...
{$ENDIF FPC}
  PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.Status, PasAI.MemoryStream,
  PasAI.DFE, PasAI.ZDB2, PasAI.Cipher, PasAI.MemoryRaster;

type
  TZDB2_List_Raster = class;
  TZDB2_Raster = class;
  TZDB2_Big_List_Raster_Decl__ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TZDB2_Raster>;
  ...
  private
    ...
    FID: Integer;
    FData: TPasAI_Raster;
    FRasterFormat: TPasAI_RasterSaveFormat;
    FIsChanged: Boolean;
  public
    ...
    property Data: TPasAI_Raster read GetData;
    property Data_Direct: TPasAI_Raster read FData;
    property ID: Integer read FID;
    property RasterFormat: TPasAI_RasterSaveFormat read FRasterFormat write FRasterFormat;
...
begin
  ...
  FData := nil;
  FRasterFormat := TPasAI_RasterSaveFormat.rsRGB;
  FIsChanged := False;
end;
...
function TZDB2_Raster.GetData: TPasAI_Raster;
begin
  if FData = nil then
    begin
      FData := NewPasAI_Raster();
      Load;
    end;
  Result := FData;
  FAlive := GetTimeTick;
