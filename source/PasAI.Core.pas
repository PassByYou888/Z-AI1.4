...
{$REGION 'BigList'}
  {$IFDEF FPC}generic{$ENDIF FPC}
  TPasAI_Raster_BL<T_> = class(TCore_Object)
  public type

    P_ = ^T_;
    PQueueStruct = ^TQueueStruct;
    PPQueueStruct = ^PQueueStruct;
    T___ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<T_>;
...
{$ENDIF DEBUG}
  ...
  {$IFDEF FPC}generic{$ENDIF FPC}
  TCritical_PasAI_Raster_BL<T_> = class(TCore_Object)
  public type

    P_ = ^T_;
    PQueueStruct = ^TQueueStruct;
    PPQueueStruct = ^PQueueStruct;
    T___ = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<T_>;
...
{$IFDEF FPC}
  generic TC_PasAI_Raster_BL<T_> = class(specialize TCritical_PasAI_Raster_BL<T_>);
{$ELSE FPC}
  TC_PasAI_Raster_BL<T_> = class(TCritical_PasAI_Raster_BL<T_>);
{$ENDIF FPC}

{$IFDEF FPC}
  generic TBig_Object_List<T_: TCore_Object> = class(specialize TPasAI_Raster_BL<T_>)
{$ELSE FPC}
  TBig_Object_List<T_: class> = class(TPasAI_Raster_BL<T_>)
{$ENDIF FPC}
  public
...
{$IFDEF FPC}
  generic TCritical_Big_Object_List<T_: TCore_Object> = class(specialize TCritical_PasAI_Raster_BL<T_>)
{$ELSE FPC}
  TCritical_Big_Object_List<T_: class> = class(TCritical_PasAI_Raster_BL<T_>)
{$ENDIF FPC}
  public
    AutoFreeObject: Boolean;
    constructor Create(AutoFreeObject_: Boolean);
...
{$REGION 'Hash-Pair'}
  ...
  public type
    ...
    PPair = ^TPair;
    TPair_PasAI_Raster_BL__ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TPair>;
    PPair__ = TPair_PasAI_Raster_BL__.PQueueStruct;
  public
    List: TPair_PasAI_Raster_BL__;
    property L: TPair_PasAI_Raster_BL__ read List;
    constructor Create;
    destructor Destroy; override;
  ...
  public type
    ...
    TPool___ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<PPair_Pool_Value__>;
...
{$Region 'ComputeThread'}
  ...
  {$ENDIF FPC}
  TCoreCompute_Thread_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TCompute>;
...
{$EndRegion 'core var'}
{$Region 'compatible'}
{$I PasAI.Core.Compatible.inc}
{$EndRegion 'compatible'}

implementation

{$I PasAI.Core.Cirtical.inc}
{$I PasAI.Core.Atomic.inc}
{$I PasAI.Core.MT19937.inc}
...
{$I PasAI.Core.ThreadPost.inc}
{$I PasAI.Core.ComputeThread.inc}

{$IFDEF FPC}
  {$I PasAI.Core.FPCParallelFor.inc}
{$ELSE FPC}
  {$I PasAI.Core.DelphiParallelFor.inc}
{$ENDIF FPC}

{$I PasAI.Core.AtomVar.inc}
...
{$I PasAI.Core.OrderData.inc}
{$I PasAI.Core.BigList.inc}
{$I PasAI.Core.Hash_Pair.inc}
