...
uses SysUtils, Classes,
  PasAI.ListEngine, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.TextDataEngine,
  PasAI.Json,
  PasAI.Core, PasAI.MemoryStream, PasAI.ZDB.ObjectData_LIB, PasAI.ZDB,
  PasAI.DFE, PasAI.ZDB.ItemStream_LIB;
...
uses PasAI.MH_ZDB, PasAI.Cipher, PasAI.Status;
  ...
  if M <> nil then
    begin
      ...
      try
        ...
        Result.MemoryUsed := PasAI.MH_ZDB.GetHookMemorySize;
        if AllowedCache then
            ProcessNewInstanceCache(StorePos, Result, Result.MemoryUsed);
      finally
          PasAI.MH_ZDB.EndMemoryHook;
      end;
    end;
end;
...
begin
  if AllowedCache then
    begin
      ...
      t.Buff := Buff;
      t.MemoryUsed := PasAI.MH_ZDB.GetHookMemorySize;
      PasAI.MH_ZDB.EndMemoryHook;
