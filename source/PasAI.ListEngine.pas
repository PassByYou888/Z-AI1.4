...
{$REGION 'Generics decl'}
  ...
  TStringBigList_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<SystemString>;
  ...
  TPascalStringBigList_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TPascalString>;
...
{$IFDEF FPC}
  streamex,
{$ENDIF FPC}
  PasAI.MemoryStream, PasAI.Status, PasAI.UnicodeMixedLib, PasAI.Parsing, PasAI.Expression, PasAI.UReplace;
