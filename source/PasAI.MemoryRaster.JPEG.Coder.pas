...
unit PasAI.MemoryRaster.JPEG.Coder;
...
uses
  SysUtils,
  PasAI.Core, PasAI.MemoryStream, PasAI.PascalStrings,
...
type
  ...
  public
    ...
    procedure Encode(S: TMS64; Iteration: Cardinal); virtual; abstract;
    procedure Decode(S: TMS64; Iteration: Cardinal); virtual; abstract;
    procedure DecodeBlock(S: TMS64; XStart, YStart, XCount, YCount: Integer); virtual; abstract;
  ...
  protected
    ...
    procedure HandleEndOfStreamError(S: TMS64); virtual;
    procedure HandleRestartInterval(S: TMS64; Warn: Boolean); virtual;
    procedure HandleHitMarkerError(S: TMS64); virtual;
    function HandleDNLMarker(McuY_: Integer; S: TMS64): Boolean; virtual;
  ...
  public
    ...
    procedure Decode(S: TMS64; Iteration: Cardinal); override;
    procedure DecodeBlock(S: TMS64; XStart, YStart, XCount, YCount: Integer); override;
    procedure Encode(S: TMS64; Iteration: Cardinal); override;
    procedure EncodeStripStart(S: TMS64);
    procedure EncodeStrip(S: TMS64);
  ...
  protected
    ...
    procedure HandleRestartInterval(S: TMS64; Warn: Boolean); override;
  public
    procedure Decode(S: TMS64; Iteration: Cardinal); override;
...
procedure TJpegBaselineCoder.Decode(S: TMS64; Iteration: Cardinal);
var
  Tile: TJpegTile;
  i: Integer;
  McuX, McuY: Integer;
...
procedure TJpegBaselineCoder.DecodeBlock(S: TMS64; XStart, YStart, XCount, YCount: Integer);
var
...
procedure TJpegBaselineCoder.Encode(S: TMS64; Iteration: Cardinal);
var
  B: Byte;
  McuX, McuY: Integer;
begin
...
procedure TJpegBaselineCoder.EncodeStrip(S: TMS64);
var
  McuX: Integer;
  B: Byte;
begin
...
procedure TJpegBaselineCoder.EncodeStripStart(S: TMS64);
begin
...
function TJpegBaselineCoder.HandleDNLMarker(McuY_: Integer; S: TMS64): Boolean;
var
  ReadBytes: Integer;
  B, Tag: Byte;
begin
...
procedure TJpegBaselineCoder.HandleEndOfStreamError(S: TMS64);
begin
...
procedure TJpegBaselineCoder.HandleHitMarkerError(S: TMS64);
begin
...
procedure TJpegBaselineCoder.HandleRestartInterval(S: TMS64; Warn: Boolean);
// Restart interval
var
...
procedure TJpegProgressiveCoder.Decode(S: TMS64; Iteration: Cardinal);
begin
...
procedure TJpegProgressiveCoder.HandleRestartInterval(S: TMS64; Warn: Boolean);
begin
  inherited;
  // Reset EOB run
  FEOBRun := 0;
