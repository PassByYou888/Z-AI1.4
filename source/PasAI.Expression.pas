...
{$ENDIF FPC}
  PasAI.Core, TypInfo, PasAI.Parsing, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib,
  PasAI.Status, PasAI.ListEngine, PasAI.OpCode;
