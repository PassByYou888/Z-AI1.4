...
{$ENDIF FPC}
  PasAI.Core, Types, PasAI.MemoryStream, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib;
...
function HypotX(const X, Y: Extended): TGeoFloat; {$IFDEF INLINE_ASM} inline; {$ENDIF INLINE_ASM} overload;
...
uses PasAI.Geometry3D, PasAI.Geometry.Low, PasAI.DFE, PasAI.Status;
