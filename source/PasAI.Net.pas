...
{$ELSE FPC}
  System.IOUtils,
{$ENDIF FPC}
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.HashList.Templet, PasAI.ListEngine, PasAI.UnicodeMixedLib, PasAI.Status,
  PasAI.DFE, PasAI.MemoryStream, PasAI.Cipher, PasAI.Notify, PasAI.Cadencer, PasAI.ZDB2;
...
{$ENDIF FPC}
  TIO_ID_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TGenericsList<Cardinal>;
  ...
  TDoubleTunnel_IO_ID_Big_List = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TDoubleTunnel_IO_ID>;
...
{$REGION 'CacheTechnology'}
  ...
  TFile_Swap_Space_Pool_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TFile_Swap_Space_Stream>;
...
{$REGION 'Queue'}
  ...
  TCritical_QueueData_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<PQueueData>;
{$ENDREGION 'Queue'}
{$REGION 'IO Decl'}
...
{$ENDIF FPC}
  ...
  TZNet_Progress_Pool_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TZNet_Progress>;
  ...
  TZNet_Instance_Pool__ = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<TZNet>;
...
{$REGION 'P2pVM'}
  ...
  TZNet_WithP2PVM_Client_Clone_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TZNet_WithP2PVM_Client>;
...
type
  THPC_Base = class;
  THPC_Instance_Pool_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<THPC_Base>;
...
uses PasAI.Net.DoubleTunnelIO, PasAI.Net.DoubleTunnelIO.VirtualAuth, PasAI.Net.DoubleTunnelIO.NoAuth;
...
begin
  if OwnerFramework.FSyncOnCompleteBuffer then
    begin
      ...
      OwnerFramework.ExecuteCompleteBuffer(self, FCompleteBufferCmd, FCompleteBufferReceivedStream.Memory, FCompleteBufferReceivedStream.Size);
...
begin
  ...
  if OwnerFramework.FFastEncrypt then
    ...
    begin
      if OwnerFramework.FUsedParallelEncrypt then
...
begin
  ...
  while FCMD_Thread_Runing_Num > 0 do
...
begin
  ...
  try
    FOwner_IO.On_Internal_Send_Byte_Buffer := {$IFDEF FPC}@{$ENDIF FPC}FOwner_IO.OwnerFramework.Framework_Internal_Send_Byte_Buffer;
    FOwner_IO.On_Internal_Save_Receive_Buffer := {$IFDEF FPC}@{$ENDIF FPC}FOwner_IO.OwnerFramework.Framework_Internal_Save_Receive_Buffer;
    FOwner_IO.On_Internal_Process_Receive_Buffer := {$IFDEF FPC}@{$ENDIF FPC}FOwner_IO.OwnerFramework.Framework_Internal_Process_Receive_Buffer;
    FOwner_IO.OnDestroy := {$IFDEF FPC}@{$ENDIF FPC}FOwner_IO.OwnerFramework.Framework_Internal_IO_Destroy;
  except
  end;
