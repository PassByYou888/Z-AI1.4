...
uses
  PasAI.h264.Types, PasAI.h264.Common, PasAI.h264.Util, PasAI.h264.Motion_comp, PasAI.h264.inter_pred, PasAI.h264.motion_est_search, PasAI.Core;
...
type
  ...
  private
    ...
    class function ClipMVRange(const mv: TMotionvec; Range: int32_t): TMotionvec;
...
procedure swapItem(var a, b: TScoreListItem);
var
  t: TScoreListItem;
begin
  t := a;
