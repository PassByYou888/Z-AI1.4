...
{ * GBK media Data                                                             * }
{ ****************************************************************************** }
unit PasAI.GBKMediaCenter;

{$I PasAI.Define.inc}

interface

uses Classes, PasAI.Status, PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings,
  PasAI.MemoryStream, PasAI.ListEngine, PasAI.TextDataEngine, PasAI.UnicodeMixedLib,
...
function InitEmptyDBStream: TMS64;
...
var
  ...
  dict_: TDictStyle;
begin
  Result := TMS64.CustomCreate($FFFF);
...
var
  ...
  rs: TCore_ResourceStream;
  tmpStream_: TMS64;
begin
  rs := TCore_ResourceStream.Create(HInstance, 'GBK', RT_RCDATA);
  tmpStream_ := TMS64.Create;
