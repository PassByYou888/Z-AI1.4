...
type
  ...
  TZDB2_ID_Pool = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<Integer>;
  ...
  TZDB2_Core_Space_Info_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TCritical_PasAI_Raster_BL<SystemString>;
