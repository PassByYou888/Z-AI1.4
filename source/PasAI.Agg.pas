...
uses
  Math,
  PasAI.Agg.Basics, PasAI.Agg.Math, PasAI.Agg.Array_LIB, PasAI.Agg.TransAffine, PasAI.Agg.TransViewport, PasAI.Agg.PathStorage, PasAI.Agg.ConvStroke, PasAI.Agg.ConvDash, PasAI.Agg.ConvTransform, PasAI.Agg.ConvCurve,
  PasAI.Agg.RenderingBuffer, PasAI.Agg.RendererBase, PasAI.Agg.RendererScanLine, PasAI.Agg.SpanGradient, PasAI.Agg.SpanImageFilterRgba, PasAI.Agg.SpanImageResampleRgba, PasAI.Agg.SpanConverter,
  PasAI.Agg.SpanInterpolatorLinear, PasAI.Agg.SpanAllocator, PasAI.Agg.RasterizerScanLineAA, PasAI.Agg.GammaFunctions, PasAI.Agg.ScanlineUnpacked, PasAI.Agg.Arc, PasAI.Agg.BezierArc, PasAI.Agg.RoundedRect,
  PasAI.Agg.PixelFormat, PasAI.Agg.PixelFormatRgba, PasAI.Agg.Color32, PasAI.Agg.MathStroke, PasAI.Agg.ImageFilters, PasAI.Agg.VertexSource, PasAI.Agg.RenderScanlines,
  PasAI.Agg.AlphaMaskUnpacked8, PasAI.Agg.ArrowHead, PasAI.Agg.BitsetIterator, PasAI.Agg.Blur, PasAI.Agg.BoundingRect, PasAI.Agg.BSpline, PasAI.Agg.ClipLiangBarsky, PasAI.Agg.ColorConversion, PasAI.Agg.Control,
  PasAI.Agg.ConvAdaptorVcgen, PasAI.Agg.ConvAdaptorVpgen, PasAI.Agg.ConvBSpline, PasAI.Agg.ConvClipPolygon, PasAI.Agg.ConvClipPolyline, PasAI.Agg.ConvConcat, PasAI.Agg.ConvContour, PasAI.Agg.ConvMarker,
  PasAI.Agg.ConvMarkerAdaptor, PasAI.Agg.ConvSegmentator, PasAI.Agg.ConvShortenPath, PasAI.Agg.ConvSmoothPoly, PasAI.Agg.Curves, PasAI.Agg.DdaLine, PasAI.Agg.Ellipse, PasAI.Agg.EllipseBresenham, PasAI.Agg.GammaLUT,
  PasAI.Agg.GradientLut, PasAI.Agg.LineAABasics, PasAI.Agg.PathStorageInteger, PasAI.Agg.PatternFiltersRgba, PasAI.Agg.PixelFormatAlphaMaskAdaptor, PasAI.Agg.PixelFormatGray, PasAI.Agg.PixelFormatRgb,
  PasAI.Agg.PixelFormatRgbPacked, PasAI.Agg.PixelFormatTransposer, PasAI.Agg.QuadratureOscillator, PasAI.Agg.RasterizerCellsAA, PasAI.Agg.RasterizerCompoundAA, PasAI.Agg.RasterizerOutline,
  PasAI.Agg.RasterizerOutlineAA, PasAI.Agg.RasterizerScanLine, PasAI.Agg.RasterizerScanlineClip, PasAI.Agg.RendererMarkers, PasAI.Agg.RendererMultiClip, PasAI.Agg.RendererOutlineAA,
  PasAI.Agg.RendererOutlineImage, PasAI.Agg.RendererPrimitives, PasAI.Agg.RenderingBufferDynaRow, PasAI.Agg.Scanline, PasAI.Agg.ScanlineBin, PasAI.Agg.ScanlineBooleanAlgebra, PasAI.Agg.ScanlinePacked,
  PasAI.Agg.ScanlineStorageAA, PasAI.Agg.ScanlineStorageBin, PasAI.Agg.ShortenPath, PasAI.Agg.SimulEq, PasAI.Agg.SpanGenerator, PasAI.Agg.SpanGouraud, PasAI.Agg.SpanGouraudGray, PasAI.Agg.SpanGouraudRgba,
  PasAI.Agg.SpanGradientAlpha, PasAI.Agg.SpanGradientContour, PasAI.Agg.SpanGradientImage, PasAI.Agg.SpanImageFilter, PasAI.Agg.SpanImageFilterGray, PasAI.Agg.SpanImageFilterRgb, PasAI.Agg.SpanImageResample,
  PasAI.Agg.SpanImageResampleGray, PasAI.Agg.SpanImageResampleRgb, PasAI.Agg.SpanInterpolatorAdaptor, PasAI.Agg.SpanInterpolatorPerspective, PasAI.Agg.SpanInterpolatorTrans, PasAI.Agg.SpanPattern,
  PasAI.Agg.SpanPatternFilterGray, PasAI.Agg.SpanPatternFilterRgb, PasAI.Agg.SpanPatternFilterRgba, PasAI.Agg.SpanPatternResampleGray, PasAI.Agg.SpanPatternResampleRgb,
  PasAI.Agg.SpanPatternResampleRgba, PasAI.Agg.SpanPatternRgb, PasAI.Agg.SpanPatternRgba, PasAI.Agg.SpanSolid, PasAI.Agg.SpanSubdivAdaptor, PasAI.Agg.Spiral, PasAI.Agg.TransBilinear, PasAI.Agg.TransDoublePath,
  PasAI.Agg.TransPerspective, PasAI.Agg.TransSinglePath, PasAI.Agg.TransWarpMagnifier, PasAI.Agg.VcgenBSpline, PasAI.Agg.VcgenContour, PasAI.Agg.VcgenDash, PasAI.Agg.VcgenMarkersTerm, PasAI.Agg.VcgenSmoothPoly1,
  PasAI.Agg.VcgenStroke, PasAI.Agg.VcgenVertexSequence, PasAI.Agg.VertexSequence, PasAI.Agg.VpGen, PasAI.Agg.VpGenClipPolygon, PasAI.Agg.VpGenClipPolyline, PasAI.Agg.VpGenSegmentator;
