...
uses PasAI.Status, PasAI.Compress;
...
begin
  ...
  if stream is TMS64 then
    begin
      Clear;
      if TMS64(stream).Size > 0 then
          WritePtr(TMS64(stream).Memory, TMS64(stream).Size);
      Position := 0;
      Exit;
    end;
