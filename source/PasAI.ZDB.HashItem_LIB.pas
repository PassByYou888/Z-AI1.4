...
{ * fast StreamQuery                                                           * }
{ ****************************************************************************** }
unit PasAI.ZDB.HashItem_LIB;

{$I PasAI.Define.inc}

interface

uses SysUtils, PasAI.ZDB, PasAI.ZDB.ItemStream_LIB, PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.ListEngine;
