...
{ ****************************************************************************** }
unit PasAI.FragmentBuffer;

{$I PasAI.Define.inc}

interface

uses PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.ListEngine, PasAI.MemoryStream;

type
  TPosition_Data = class;
  TFragment_Space_Tool = class;

  TPosition_Buffer_Tool_ = {$IFDEF FPC}specialize {$ENDIF FPC} TPasAI_Raster_BL<TPosition_Data>;
  ...
  public
    ...
    function Repeat_: TPosition_Buffer_Tool.TRepeat___;
...
uses PasAI.Geometry2D, PasAI.UnicodeMixedLib, PasAI.Status;
...
function TFragment_Space_Tool.Repeat_: TPosition_Buffer_Tool.TRepeat___;
begin
