...
uses SysUtils, Classes,
  PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.Net, PasAI.Core, PasAI.UnicodeMixedLib, PasAI.MemoryStream, PasAI.Notify,
  PasAI.synsock, PasAI.blcksock;
